...
simpleLongDlg["Mausoleum"] = function()
	local str = [[当你蹑手蹑脚的进入时，你踩到了某个机关，身后落下了一块巨石堵住了所有的退路。空气又闷又热，并且在这封闭的空间里，你仿佛被活埋在棺材里一样。

使你感到不安的是一种恐惧感，一种超过畏惧的恐惧感。大厅的门就在前方，你能感受到门后潜藏的怨恨和邪恶能量。在转角的尽头你看到黑色的大门下面透出昏暗的灯光，并且你能模糊的感受到其他的门受牵制于这扇大门——顺从，谦卑并且奴役……

你听到一个女人的哭泣，时不时还夹杂着一声痛苦的哀嚎和尖叫。声音在密室里回荡并且通过黑暗传入了你的大脑，提醒你所犯的每一项罪过。内疚、恐怖和害怕如潮水般袭来，它们每个都紧紧抓住了你的灵魂。你唯一的想法便是逃离此地，不择一切手段。]]
	return "陵墓",str
end

simpleLongDlg["Danger..."] = function(str)
		if str:find("After walking many hours, ") then
		str = [[在行走了几个小时后，你终于到达了终点。你站在了你能看到的最高峰位置。
风暴在你的头顶肆虐。]]
	elseif str:find("You step out on unfamiliar grounds.") then
		str = [[你进入了一个不熟悉的地方。你几乎站在了你能看到的最高峰位置。
风暴在你的头顶肆虐。]]
	elseif str:find("As you arrive in Derth you notice") then
		str = [[当你到达德斯镇时你注意到小镇上空有一大团黑压压的乌云。你听到小镇广场上传来的尖叫声。]]
	else
		str= [[你上次过来时，这个洞穴里满是你杀死的兽人尸体。现在，更多的尸体铺在了地上，呈烧焦状态并且散发着糊味。桔色的昏暗灯光照亮了洞穴延伸的东面。]]
	end
	return "危险……", str
end
...
simpleLongDlg["Back and there again"] = function(str)
		...
		str = [[仔细检查恶魔的身体会发现一把血符祭剑和一块共鸣宝石，尽管它们都沾上了烟尘和鲜血，但看起来仍完好无损。]]
	else
		str = [[当阴影消退，你没有找到任何《关于力场翻转与回复的可能性研究》标题的文本。你必须回到泰恩那。]]
	end
	return "穿越回来", str
end

simpleLongDlg["Melinda"] = function()
	return "米琳达", [[这个女人似乎从镣铐中释放了出来。她蹒跚着脚步，她赤裸的身躯滴落着鲜血。“请带我离开这里！”]]
end

simpleLongDlg["Crypt"] = function()
	return "地下室", [[这个女人发出了一声刺耳欲聋的尖叫声，当她的胃被黑色的爪子撕裂时突然转为恐怖的惊叫。一个铁塔般的恶魔站了起来，将她的血肉撕裂，并且代替她临终惨叫的是一声恐怖的怒吼。]]
end

simpleLongDlg["Unknown Sher'Tul Fortress"] = function()
	return "未知夏·图尔堡垒",[[随着突然的震动，你发现你自己……某些地方变的熟悉了。那光滑的墙壁和温暖的灯光提醒你这是你的堡垒。不过它仍然有所不同。背后有着轻柔的颂歌声，你感觉整个身体轻飘飘的，几乎像羽毛一样，似乎你轻轻的移动都能跃至半空。你有着一种奇异的感觉——你似乎不在马基·埃亚尔了……在你的前方你感到了某种可怕和完美，恐慌和奇妙感充满了你身心的每个角落。]]
end
...
simpleLongDlg["Clear sky"] = function(str)
		...
		str = [[似乎伊格兰斯们遵守了他们的诺言。德斯镇的风暴威胁解除了。]]
	else
		str = [[似乎法师们遵守了他们的诺言。德斯镇的风暴威胁解除了。]]
	end
	return "清理天空",str
end
...
simpleLongDlg["Transmogrification Chest"] = function()
	str = [[这个盒子是伊克格的延伸，任何放进盒子里的物品都可以被传送至堡垒，由核心控制并将其转化为能量。
这个盒子的副产品是金币，而金币对于堡垒来说是无用的，所以它会返回给你。

当你持有这个盒子时，你经过的所有地面上的物品都会被自动捡起，并且在你离开当前层时会全部转化。
...
simpleLongDlg["Yiilkgur"] = function(str)
	...
	then 
		str = [[这个区域似乎独立于世，空气清新，天空晴朗。你听到远处传来魔法的撞击声。]]
	else 
		str = [[当你进入熟悉的堡垒时，你发现一只橙色的小猫不知怎么跟着你进来了。
它似乎就是你不久前喂过的那一只]]
	end
	return "伊克格", str
end
...
simpleLongDlg["Conclave Vault"] = function()
	return "孔克雷夫地下实验室",[[在你到达地图上坐标所指的位置时，你惊奇地发现地上有一个巨大的裂谷，深邃的谷底中闪烁着金属的光泽，那是一扇古老的大门。看起来，魔法大爆炸的强大力量所造成的地震正好将地面切裂，让本来在爆炸中被毁的，通向孔克雷夫古老遗迹的通道重现人间。你小心地从裂谷上攀爬而下，站在门前。]]
end

simpleLongDlg["Tannen's Tower"] = function() 
	return "泰恩之塔",[[
	当你爬上楼梯，你看到泰恩正和他的龙傀儡站在一起，手中拿着一张羊皮纸。在他阅读的时候，他的眉头紧皱，汗如雨下，不断来回踱步着。当他攥起纸条试图放进口袋里的时候，他突然望见了你，如同一只受惊吓的猫一样向后跳了几步。“不！不是现在！你根本不懂，现在是生死攸关的时刻！”他从长袍中拿出一把彩色的小瓶子，身旁龙傀儡站了起来，眼睛放射出光芒，金属的响声如同真龙的吼叫一般，让你印象深刻。]]
end
...
simpleLongDlg["Cursed Fate"] = function(str)
	str = str:gsub(" lies defiled at your feet. An aura of hatred surrounds you and you now feel truly cursed. You have gained the Cursed Aura talent tree and 1 point in Defiling Touch, but at the cost of 2 Willpower.", " 。一个诅咒光环笼罩了你，你感到自己被诅咒了。你获得了诅咒光环技能树和等级 1 的诅咒之触，但是需永久消耗 2 点意志。")
	str = str:gsub("The ", "你的脚下躺着受诅咒的 ")
	return "被诅咒的命运", str
end
...
感谢您购买了#CRIMSON#乌鲁洛克之烬#WHITE#，《马基埃亚尔的传说》的第一个扩展包。

若要开始一段与恶魔共舞的毁灭旅程，请您选择毁灭使者（堕落系）作为您的职业，选择%s
作为你的职业。
...
simpleLongDlg["Strange metallic capsule"] = function()
	return "诡异的金属舱", [[
出现在你眼前的是一个被绿色玻璃遮罩的太空舱，根据附近的弹坑判断，这个太空舱曾以极快的速度撞击地面，里面仍坐着一个奇怪的生物，穿着不明材质的衣服，带着绿色玻璃做成的头罩。透过绿色的玻璃看去，能看到矮人标志性的大鼻子，你清楚的发现这是一个矮人！从气味判断，他已经死了很久了。]]
end

simpleLongDlg["Hungry"] = function()
	return "饥饿", [[
这是一个寒冷的夜晚，白天你没有找到任何可以果腹的东西，你的储备的皮毛也不足以御寒。于是你决定外出狩猎，但其他人都警告你不要这样做。夜晚很危险，而且天空也闪烁着诡异的光芒，如此不详的预兆。但近来食物已经越来越难得，每个人都和你一样饥饿。]]
end

simpleLongDlg["Chanting"] = function()
	return "吟诵声", [[
这里充斥着被悬挂起来死灵的残肢，地上满是腐败恶臭的粘液。这里一定是某种死灵仪式的现场，当你更仔细的倾听时，你听到远处的巢穴深处中传来充满痛苦的嘶吼。声音粗野而深沉，仿佛是龙的吼声与巨人咆哮混合在一起，这正是你要拯救的克罗格的声音，你并不明白死灵法师要在他们身上做什么实验，但你知道，自己一定要在实验成功前阻止他们。]]
end

simpleLongDlg["Urgent affair in Zigur"] = function()
	return "来自伊格的紧急事件", [[当你进入最后的希望时, 一个信使找到你并给你一份来自守护者米歇尔的信:
