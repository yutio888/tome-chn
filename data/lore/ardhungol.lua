...
registerLoreTranslation{
	...
	category = "ardhungol",
	name = "破纸片",
	lore = function() return game and game.state and game.state.spydre_mantra and [[#{italic}#地上有一些破烂的纸片，看来在你刚才和那个生物搏斗的时候被打碎了。纸片上的文字几乎完全无法辨认，你只能依稀拼凑出一些文字：#{normal}#
"…对大部分埃亚尔野生生命体有效的信息素在“太阳骑士”这种物种的身上被证明无效。在当前的行星核心冷却速率下，被动的研究会导致巨大的损失——移民计划的下一步是对本地的“太阳骑士”进行杀灭和建立…"]]
or
[[#{italic}#原理上，从这些破烂的纸片上可以还原出某些可以理解的信息。但缺少了足够多作为参考的语料，你是永远无法理解这种语言的内容的。也许找到更多蜘蛛语的材料能够帮助你理解这些……#{normal}#]]
end
}
