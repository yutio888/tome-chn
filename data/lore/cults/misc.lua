...
registerLoreTranslation{
	...
	lore = [[孩子们，我要教给你们的第一堂课是有关理解如何利用熵的力量。当你们使用它的力量的时候，也不可避免会受到它带来的凋零的影响。你的身体将会受到你使用的法术的反馈，并一直携带着这份残留的能量。因此，你从创伤中恢复的能力将会严重受到影响。然而，你可以学会抵抗这种反馈，甚至将这种命运的诅咒传递给你的敌人。
...
我有些犹豫要不要教你们这个法术，但你们所有人目前为止表现都很好。你#{italic}#一定#{normal}#不能轻率使用这个法术。在你的头脑中一定要对你要召唤什么有一个清晰的印象，否则你将会把自己暴露在虚空的支配之下。在群星之间有着无数的存在，而它们中的大部分都是无意识而无情的恐怖存在。
