...
function npcCHN:getNameOld(name)
	...
	elseif name:find("servant") then 
		local tname = name:gsub("golem %(servant of ","")
			...
			:gsub("worm that walks %(servant of ","")
			:gsub("Worm that walks %(servant of ","")
			:gsub("%)","")
		if tname:find("servant") then return name end
		local chnname = npcCHN:getName(tname)
		name = name:gsub("golem %(servant of","傀儡(")
			:gsub("Golem %(servant of","傀儡(")
			:gsub("%)","的仆人)")
			:gsub("worm that walks %(servant of ","蠕虫合体(")
			:gsub("Worm that walks %(servant of ","蠕虫合体(")
			:gsub(tname,chnname)
...
npcNameCHN["Director Hompalan"] = "研究主管红帕兰"
...
npcDescCHN["Training Dummy"] = "训练用傀儡。用它来训练吧！"
...
npcDescCHN["sewer alligator"] = [[多么的老套！]]
npcNameCHN["giant alligator"] = "巨型鳄鱼"
npcDescCHN["giant alligator"] = [[多么的老套，并且可怕！]]
npcNameCHN["pet yeti"] = "宠物雪人"
npcDescCHN["pet yeti"] = [[这个雪人比一般的雪人要小一些，它的毛发看起来被梳理过。不仅如此，它看起来对它主人的家园被入侵了不太高兴。]]
npcNameCHN["guard yeti"] = "雪人守卫"
npcDescCHN["guard yeti"] = [[这个雪人巨大且愤怒，他的爪子被打磨的远比那些野生雪人的锋利。]]
npcNameCHN["basaligator"] = "蛇蜥魔鳄"
npcDescCHN["basaligator"] = [[这个东西看上去像是只鳄鱼，但是它有一双大的不自然的灰色眼睛。它正在紧紧的盯着你。]]
npcNameCHN["attack yeti"] = "雪人攻击者"
npcDescCHN["attack yeti"] = [[这个雪人的爪子上套着锋利的铁刺，狂怒的瞪着你。]]
npcNameCHN["hethugoroth"] = "赫斯格鲁斯"
npcDescCHN["hethugoroth"] = [[一个灼热的蒸汽漩涡所形成的生命体。]]
npcNameCHN["greater hethugoroth"] = "大型赫斯格鲁斯"
npcDescCHN["greater hethugoroth"] = [[一个灼热的蒸汽漩涡所形成的生命体。]]
npcNameCHN["ultimate hethugoroth"] = "终极赫斯格鲁斯"
npcDescCHN["ultimate hethugoroth"] = [[一个灼热的蒸汽漩涡所形成的生命体。]]
npcNameCHN["steam drone"] = "蒸汽机器人"
npcDescCHN["steam drone"] = [[这是个看上去很像蜘蛛的八腿机械构造体。它正向你飞速冲来并准备用颚部的旋转锯刃将你撕成碎片。]]
npcNameCHN["ritch larva"] = "里奇幼虫"
npcDescCHN["ritch larva"] = [[里奇是一种远东南部的巨型土著昆虫。]]
npcNameCHN["ritch hunter"] = "里奇猎手"
npcDescCHN["ritch hunter"] = [[里奇是一种远东南部的巨型土著昆虫。]]
npcNameCHN["ritch hive mother"] = "里奇巢母"
npcDescCHN["ritch hive mother"] = [[里奇是一种远东南部的巨型土著昆虫。]]
npcNameCHN["ritch centipede"] = "里奇百足虫"
npcDescCHN["ritch centipede"] = [[这个奇怪的生物看上去像是一个里奇猎手，但是它的脚要多多了，多很多很多。]]
npcNameCHN["larvae bloated ritch mother"] = "满载幼虫的里奇巢母"
npcDescCHN["larvae bloated ritch mother"] = [[这个生物的皮肤上爬满了幼虫，字面意义上的爬满。尽管如此，她向你前进的速度非常快。]]
npcNameCHN["necropsych's ghost"] = "通灵师的鬼魂"
npcDescCHN["necropsych's ghost"] = [[这是一个在近期死亡的通灵师的灵魂。它痛苦的哀鸣着，无视现实世界的一切。]]
npcNameCHN["steam giant necropsych"] = "蒸汽巨人通灵师"
npcDescCHN["steam giant necropsych"] = [[这个被死亡符文所覆盖的蒸汽巨人是个大麻烦。]]
npcNameCHN["steam giant blood carver"] = "蒸汽巨人血雕者"
npcDescCHN["steam giant blood carver"] = [[尽管血液不停地从这个高大的巨人身上渗出，他看上去却没有任何不适。]]
npcNameCHN["steam giant gunner"] = "蒸汽巨人枪手"
npcDescCHN["steam giant gunner"] = [[这个蒸汽巨人拿着一把看上去威力很强的枪。]]
npcNameCHN["steam giant gunslinger"] = "蒸汽巨人快枪手"
npcDescCHN["steam giant gunslinger"] = [[这个蒸汽巨人双手各拿着一把蒸汽枪。]]
npcNameCHN["steam giant guard"] = "蒸汽巨人守卫"
npcDescCHN["steam giant guard"] = [[这个拿着巨型剑盾的庞大人形正在向你走来。]]
npcNameCHN["steam giant flameshot"] = "蒸汽巨人火焰射手"
npcDescCHN["steam giant flameshot"] = [[这个蒸汽巨人双手各拿着一把枪管在燃烧的蒸汽枪。]]
npcNameCHN["steam giant berserker"] = "蒸汽巨人狂战士"
npcDescCHN["steam giant berserker"] = [[这个蒸汽巨人双手拿着一柄无比庞大的巨剑，你看到剑刃被厚厚的蒸汽云团包裹着。]]
npcNameCHN["steam giant yeti rider"] = "蒸汽巨人雪人骑士"
npcDescCHN["steam giant yeti rider"] = [[这个拿着巨剑的蒸汽巨人骑在一只重甲雪人身上。]]
npcNameCHN["retaliator of Atmos"] = "阿特姆斯复仇者"
npcDescCHN["retaliator of Atmos"] = [[这个蒸汽巨人双手各拿着一把蒸汽枪。她来此唯一的目的就是消灭任何对阿特姆斯部落的威胁。]]
npcNameCHN["sun-mage recruit"] = "太阳法师新兵"
npcDescCHN["sun-mage recruit"] = [[一个穿着荧光法袍的法师。]]
npcNameCHN["mecharachnid warrior"] = "机械蛛武士"
npcDescCHN["mecharachnid warrior"] = [[这是个看上去很像蜘蛛的八腿机械构造体。它正向你飞速冲来并准备用颚部的旋转锯刃将你撕成碎片。]]
npcNameCHN["sun-mage"] = "太阳法师"
npcDescCHN["sun-mage"] = [[一个穿着闪亮法袍的法师。]]
npcNameCHN["anorithil"] = "星月术士"
npcDescCHN["anorithil"] = [[一个穿着同时描绘了光与暗的华丽法袍的法师。]]
npcNameCHN["astral conjurer"] = "星空咒术师"
npcDescCHN["astral conjurer"] = [[一个穿着同时描绘了光与暗的华丽法袍的法师。]]
npcNameCHN["mecharachnid flame thrower"] = "机械蛛喷火者"
npcDescCHN["mecharachnid flame thrower"] = [[这是个看上去很像蜘蛛的八腿机械构造体。尽管蜘蛛可不会有它背后装载的巨型火焰喷射器。]]
npcNameCHN["elven astromancer"] = "精灵星术师"
npcDescCHN["elven astromancer"] = [[一个将毕生精力投入到了对星辰及其原理的学习中的法师。]]
npcNameCHN["mecharachnid destroyer"] = "机械蛛毁灭者"
npcDescCHN["mecharachnid destroyer"] = [[这是个看上去很像蜘蛛的八腿机械构造体。一个武装到牙齿，呃，颚部的蜘蛛。]]
npcNameCHN["mecharachnid repairbot"] = "机械蛛维修者"
npcDescCHN["mecharachnid repairbot"] = [[这是个看上去很像蜘蛛的八腿机械构造体。比起你，它似乎更关心它的同胞们。]]
npcNameCHN["sunwall guard"] = "太阳堡垒守卫"
npcDescCHN["sunwall guard"] = [[这个身着太阳堡垒徽记的守卫挺拔而骄傲的站立着。]]
npcNameCHN["sunwall archer"] = "太阳堡垒弓箭手"
npcDescCHN["sunwall archer"] = [[你看到了一个拉着弓的射手，他的护甲上有金色太阳的压纹。]]
npcNameCHN["sun paladin recruit"] = "太阳骑士新兵"
npcDescCHN["sun paladin recruit"] = [[这个士兵的盾牌闪耀着强光。你看到盾牌的中央雕刻着一个金色的太阳，同时他的另一只手拿着一柄剑。]]
npcNameCHN["titan battlesmasher"] = "泰坦碎颅者"
npcDescCHN["titan battlesmasher"] = [[这个生物看上去像是一个蒸汽巨人，但是更巨大，更恶心，并且被某种未知力量腐化了。天啊，他还拿着一个巨锤！]]
npcNameCHN["sun paladin"] = "太阳骑士"
npcDescCHN["sun paladin"] = [[这个士兵的盾牌与剑都闪耀着强光。你看到盾牌的中央雕刻着一个金色的太阳。]]
npcNameCHN["titanic horror"] = "泰坦恐魔"
npcDescCHN["titanic horror"] = [[尽管一般的泰坦看上去像是一个堕落的蒸汽巨人，这一个看上去更像是一个巨人大小的恐怖血肉团块。]]
npcNameCHN["sunwall vindicator"] = "太阳堡垒维护者"
npcDescCHN["sunwall vindicator"] = [[这个看上去十分凶恶的太阳堡垒士兵稳稳地握着一柄双手剑，他正在用危险的目光看着你。]]
npcNameCHN["titan searing seer"] = "泰坦炙热先知"
npcDescCHN["titan searing seer"] = [[你能感受到从这个被奥术火焰所环绕的泰坦所放射出的强大的精神力量正在你的心灵中回荡。]]
npcNameCHN["titan vile spewer"] = "泰坦呕吐魔"
npcDescCHN["titan vile spewer"] = [[这个恶心的泰坦的皮肤呈现一种粘乎乎的绿色，满是不停的流着粘液的伤口，裂缝，和脓疱。蠕虫和其他各种卑劣的东西在他身上爬来爬去。]]
npcNameCHN["troll pirate"] = "巨魔海盗"
npcDescCHN["troll pirate"] = [[这是一个巨魔海盗。]]
npcNameCHN["troll marauder"] = "巨魔掠夺者"
npcDescCHN["troll marauder"] = [[这个精壮的巨魔熟练使用着一对匕首。他看向你的目光中满是狡诈。]]
npcNameCHN["titan dreadnought"] = "泰坦无畏勇士"
npcDescCHN["titan dreadnought"] = [[这是你见过的最大的泰坦，他被一身深黑色的蓝锆石全身甲所覆盖，正迈着可怕的步伐向你冲来。]]
npcNameCHN["troll captain"] = "巨魔船长"
npcDescCHN["troll captain"] = [[这个巨魔正在咆哮着地对他身旁的巨魔下达命令。他毫不费力的双手各拿着一柄长剑。]]
npcNameCHN["sher'tan"] = "夏尔泰坦"
npcDescCHN["sher'tan"] = [[这个孽物和其他泰坦差不多高，但是他的特征让你回想起了你见过的那些夏图尔人图片。你竭尽全力的抗拒这些想法，你的心灵已被纯粹的恐惧所控制。]]
npcNameCHN["troll guard"] = "巨魔守卫"
npcDescCHN["troll guard"] = [[这只巨魔拿着巨大的剑盾，身上穿了一些零碎的护甲。]]
npcNameCHN["troll aquamancer"] = "巨魔控水师"
npcDescCHN["troll aquamancer"] = [[这只巨魔一只手拿着一柄长杖。他的身边盘绕着由水组成的触手。]]
npcNameCHN["gargantuan sher'tan"] = "庞大的夏尔泰坦"
npcDescCHN["gargantuan sher'tan"] = [[这个孽物和其他泰坦差不多高，但是他的特征让你回想起了你见过的那些夏图尔人图片。你竭尽全力的抗拒这些想法，你的心灵已被纯粹的恐惧所控制。]]
npcNameCHN["whitehoof ghoul"] = "白蹄尸鬼"
npcDescCHN["whitehoof ghoul"] = [[他像是人类和公牛组合出来的，除了更……死。]]
npcNameCHN["undead drake hatchling"] = "亡灵幼龙"
npcDescCHN["undead drake hatchling"] = [[一只骷髅幼龙；并不怎么强，但是如果他们的习性还像活着的时候那样的话，这里恐怕有不止一只。]]
npcNameCHN["whitehoof maulotaur"] = "巨锤白蹄"
npcDescCHN["whitehoof maulotaur"] = [[这个巨大的亡灵牛头人拿着一把灌注了闪电的可怕巨锤。]]
npcNameCHN["undead drake"] = "亡灵飞龙"
npcDescCHN["undead drake"] = [[一只骷髅飞龙，有着致命的吐息和可怕的利爪。]]
npcNameCHN["whitehoof invoker"] = "白蹄唤魔者"
npcDescCHN["whitehoof invoker"] = [[不详的奥术能量环绕着这个强大的死灵。]]
npcNameCHN["undead wyrm"] = "亡灵巨龙"
npcDescCHN["undead wyrm"] = [[一只活了很久的巨龙的骷髅，有着致命的吐息和可怕的利爪。]]
npcNameCHN["whitehoof hailstorm"] = "白蹄霜雹使"
npcDescCHN["whitehoof hailstorm"] = [[看上去这个可怕的死灵身周的空气都冻结凋零了。]]
npcNameCHN["yeti cub"] = "雪人幼崽"
npcDescCHN["yeti cub"] = [[这个类人生物身上长着厚实的白毛。]]
npcNameCHN["yeti"] = "雪人"
npcDescCHN["yeti"] = [[这个大型的类人生物身上长着厚实的白毛。]]
npcNameCHN["yeti warrior"] = "雪人勇士"
npcDescCHN["yeti warrior"] = [[这个巨大的类人生物身上长着厚实的白毛，和危险的巨爪。他看上去十分愤怒。]]
npcNameCHN["yeti demolisher"] = "雪人爆破者"
npcDescCHN["yeti demolisher"] = [[这个巨大的类人生物身上长着厚实的白毛，和危险的巨爪。你会喜欢被他肌肉满满的双臂拥抱一下吗？]]
npcNameCHN["shadow of pain"] = "痛之影"
npcDescCHN["shadow of pain"] = [[一团由痛苦具现成的阴影。]]
npcNameCHN["shadow of hate"] = "恨之影"
npcDescCHN["shadow of hate"] = [[一团由恨意具现成的阴影。]]
npcNameCHN["shadow of despair"] = "惘之影"
npcDescCHN["shadow of despair"] = [[一团由绝望具现成的阴影。]]
npcNameCHN["shadow of remorse"] = "悔之影"
npcDescCHN["shadow of remorse"] = [[一团由悔恨具现成的阴影。]]
npcNameCHN["shadow of guilt"] = "罪之影"
npcDescCHN["shadow of guilt"] = [[一团由罪怨具现成的阴影。]]
npcNameCHN["shadow of anger"] = "怒之影"
npcDescCHN["shadow of anger"] = [[一团由愤怒具现成的阴影。]]
npcNameCHN["Crimson Templar John"] = "深红骑士约翰"
...
npcNameCHN["Haze Commander Parmor"] = "阴霾指挥官帕默"
...
npcNameCHN["Nektosh the One-Horned"] = "独角者纳克托什"
...
npcNameCHN["Council Member Pendor"] = "议会成员潘多尔"
npcDescCHN["Council Member Pendor"] = [[这位手拿两把巨大的蒸汽枪的巨人却表现出令人吃惊的敏捷和难以捉摸。十分致命！]]
npcNameCHN["Council Member Palaquie"] = "议会成员帕拉奎"
...
npcDescCHN["Council Member Tantalos"] = [[我们应该假设气之部族的最高官员应该并不是一个面目可憎的巨大怪物。他让你联想起你对夏图尔人的模糊印象，但这不自然的外观和令人作呕的咕噜声让你从理性到情感的每一个层面都充满厌恶。憎恶这种恐怖生物的原始本能似乎潜藏于你的心灵中，比一切语言都要古老。如果他真的是的话…好吧，他还真是个贿选高手。]]
...
npcDescCHN["Crystallized Primal Root"] = [[这个曾经伟大的原始树木，已经被疯狂蔓延的水晶侵蚀注入和腐化。真是可怕的结局。]]
...
npcNameCHN["Sher'Tul High Priest"] = "夏·图尔高阶祭司"
...
npcNameCHN["Outpost Leader John"] = "前哨站队长约翰"
...
-- cults DLC
-- dremshor-tunnel
npcNameCHN["half formed drem"] = "半成型的德瑞姆"
npcDescCHN["half formed drem"] = "这是一个矮小的无面人，有着难以辨认的矮人的特征。他的战斧和盾牌破旧不堪，似乎从来没有修好。"
npcNameCHN["The Amalgamation"] = "融合怪"
npcDescCHN["The Amalgamation"] = "从零开始创造一个生物并不是一件容易的事情。有很多地方可能出错，比如多了点眼睛，多了点四肢，少了点脑子，或者把无数躯体融合成这样一团血肉和骨骸组成的，蠕动着的巨大怪物。尽管这个生物体型庞大，它仍然可以轻快地移动，很快缩小了和你之间的距离"
-- entropic-void
npcNameCHN["Hypostasis of Entropy"] = "熵之源质"
npcDescCHN["Hypostasis of Entropy"] = "扭曲的躯体张开巨口，在你的眼前浮现。所有的文明，所有的生命，所有的物质，所有的光芒终究会屈服在熵的面前。恐惧让你感到冰冷，你意识到了这一最可怕的可能性。宇宙热寂的本质即将吞噬你。"
-- ft-cultist
npcNameCHN["Unspeakable Thing"] = "不可名状之物"
npcDescCHN["Unspeakable Thing"] = "一位学徒因为愚蠢的骄傲而错误的把这样东西召唤到了你的世界。深不可测的黑暗从他的身边喷涌而来，吞噬着周围的一切光芒。当黑暗触及你的时候，你只感受到一件事…饥饿，无尽的饥饿，如同宇宙的虚空一样广阔而无穷无尽。"
npcNameCHN["The Teacher"] = "导师"
npcDescCHN["The Teacher"] = "这是一位来自另一个世界的生物，起码它是这么说的。尽管它的外形十分怪异，但是它并没有表现出威胁，也没有什么恶意。他从不说出自己是怎么获得操纵熵的力量的，只是告诉你他曾经去过无数不同的地方，经历无数不同的事情。"
npcNameCHN["human student"] = "人类学徒"
npcDescCHN["human student"] = "一个人类学徒"
npcNameCHN["shalore student"] = "永恒精灵学徒"
npcDescCHN["shalore student"] = "一个永恒精灵学徒"
npcNameCHN["halfling student"] = "半身人学徒"
npcDescCHN["halfling student"] = "一个半身人学徒"
-- ft-haze-cave
npcNameCHN["Great Tentacly Being"] = "伟大的触手怪物"
npcDescCHN["Great Tentacly Being"] = "你无法理解你看到了什么。\n#{bold}##CRIMSON#你知道，如果你试图干涉他们的战斗，这些东西会如同对待虫子一样轻松把你捏碎。#{normal}#"
-- ft-horrors
npcNameCHN["The One That Writes"] = "故事撰写者"
npcDescCHN["The One That Writes"] = "尽管它注意到了你，它的众多触须仍然继续专注地在一张奇怪的纤细羊皮纸上书写着文字。随着它的书写，你周围的一切都在发生着变化，身边的物体和地面变得更加清晰。你可不想让他决定你人生故事的结尾。"
-- ft-illusory-castle
npcNameCHN["minotaur mindscrew"] = "米诺陶灵能之锤"
npcDescCHN["minotaur mindscrew"] = "这个好战的米诺陶有着强大的精神力量。他一手拿着锤子，一手拿着巨大的石块。"
npcNameCHN["The Glass Golem"] = "玻璃傀儡"
npcDescCHN["The Glass Golem"] = "这是一个巨大的机械傀儡，完全由玻璃制成。它似乎是整个城堡的卫士，看守着王座周围的宝箱。"
-- godfeaster
npcNameCHN["The Divine Writhing Mass"] = "古神扭曲的物质"
npcDescCHN["The Divine Writhing Mass"] = "这曾经是巨大蛆虫的神经系统，在它吞噬了某个死去已久的古神的时候，变成了另一种可怕的存在。如果将其摧毁，所谓的噬神者也会死去。"
npcNameCHN["Malyu"] = "马吕乌"
npcDescCHN["Malyu"] = "这个勇敢的冒险家救了你。"
-- maggot
npcNameCHN["The Spinal Cord"] = "脊髓"
npcDescCHN["The Spinal Cord"] = "巨大蛆虫的神经中枢。如果将其摧毁，巨大蛆虫也会死去。"
-- necromancers-ruins
npcNameCHN["Chanting Necromancer"] = "念咒的死灵法师"
npcDescCHN["Chanting Necromancer"] = "一个冷酷的吸血鬼死灵法师。他似乎正在吸取克罗格的生命能量来用于某种邪恶的目的。"
npcNameCHN["Grand Necromancer"] = "大死灵法师"
npcDescCHN["Grand Necromancer"] = "你不敢相信你的眼睛，在你面前死灵法师们的领袖竟然是一个巫妖。"
npcNameCHN["captive krog"] = "被抓走的克罗格"
npcDescCHN["captive krog"] = "这位巨人，自然力量的化身竟然被人抓获并俘虏。显然，死灵法师们的力量不能轻视。"
-- scourged-pits
npcNameCHN["awoken tentacle tree"] = "被唤醒的触手树"
npcDescCHN["awoken tentacle tree"] = "触手树活起来了！"
npcNameCHN["Kroltar the Scourge"] = "天灾巨龙库洛塔"
npcDescCHN["Kroltar the Scourge"] = "库洛塔，埃亚尔历史上最为伟大的火龙。传说矮人远征队杀死了他，不过另外一些东西似乎占据了这个曾经骄傲的巨龙的躯体，让它重新变成一种新的扭曲的生命形态。"
-- town-kroshkkur
npcNameCHN["drem cultist"] = "德瑞姆邪教徒"
npcDescCHN["drem cultist"] = "一位德瑞姆邪教徒"
npcNameCHN["drem seeker of knowledge"] = "德瑞姆知识探求者"
npcDescCHN["drem seeker of knowledge"] = "一位身穿红袍的德瑞姆，他正在思考自己的事情。"
npcNameCHN["disfigured creature"] = "不成型的生物"
npcDescCHN["disfigured creature"] = "一团不成型的生物，正在无目的地游荡。"
npcNameCHN["That Which Teaches History"] = "历史教师"
npcDescCHN["That Which Teaches History"] = "这个生物掌管着避难所的图书馆。"
npcNameCHN["The Sightless Acolyte"] = "盲目的侍僧"
npcDescCHN["The Sightless Acolyte"] = "这个生物在避难所出售武器。"
npcNameCHN["The Crawler"] = "爬行者"
npcDescCHN["The Crawler"] = "这个生物在避难所出售法杖。"
npcNameCHN["The One That Defends"] = "防卫者"
npcDescCHN["The One That Defends"] = "这个生物在避难所出售防具。"
npcNameCHN["The Face of the Deep"] = "深渊之貌"
npcDescCHN["The Face of the Deep"] = "这个生物在避难所出售纹身和符文。"
npcNameCHN["The Conjointed"] = "合体者"
npcDescCHN["The Conjointed"] = "这个生物在避难所出售工具。"
-- blobs
npcNameCHN["plasmic disruptor"] = "原生质破坏者细胞"
npcDescCHN["plasmic disruptor"] = "这团绿色的软泥是蛆虫的防御细胞"
npcNameCHN["mastocytic feeder"] = "饲育者肥大细胞"
npcDescCHN["mastocytic feeder"] = "一团红色的攻击细胞，它会爬到你的身边，在其他器官攻击你的时候分散你的注意力。"
npcNameCHN["protoplasmic controller"] = "原生质操控细胞"
npcDescCHN["protoplasmic controller"] = "酸液。火焰。痛苦。"
npcNameCHN["dendritic hemospinner"] = "树突血细胞"
npcDescCHN["dendritic hemospinner"] = "这个奇怪的细胞似乎可以通过某种方法连接到埃亚尔本身。"
npcNameCHN["acidic digestor"] = "酸性消化细胞"
npcDescCHN["acidic digestor"] = "看来你看起来是某种营养物质。"
npcNameCHN["protosentient globula"] = "原生球状细胞"
npcDescCHN["protosentient globula"] = "一团球状的巨大的原生质细胞。从他的身上渗出原生质，你感觉他很饥饿。"
-- corrupted_blobs
npcNameCHN["corrupted plasmic disruptor"] = "腐化的原生质破坏者细胞"
npcDescCHN["corrupted plasmic disruptor"] = "这团绿色的软泥是蛆虫的防御细胞"
npcNameCHN["corrupted mastocytic feeder"] = "腐化的饲育者肥大细胞"
npcDescCHN["corrupted mastocytic feeder"] = "一团红色的攻击细胞，它会爬到你的身边，在其他器官攻击你的时候分散你的注意力。"
npcNameCHN["corrupted protoplasmic controller"] = "腐化的原生质操控细胞"
npcDescCHN["corrupted protoplasmic controller"] = "酸液。火焰。痛苦。"
npcNameCHN["corrupted dendritic hemospinner"] = "腐化的树突血细胞"
npcDescCHN["corrupted dendritic hemospinner"] = "这个奇怪的细胞似乎可以通过某种方法连接到埃亚尔本身。"
npcNameCHN["corrupted acidic digestor"] = "腐化的酸性消化细胞"
npcDescCHN["corrupted acidic digestor"] = "看来你看起来是某种营养物质。"
npcNameCHN["corrupted protosentient globula"] = "腐化的原生球状细胞"
npcDescCHN["corrupted protosentient globula"] = "一团球状的巨大的原生质细胞。从他的身上渗出原生质，你感觉他很饥饿。"
-- horror-special
npcNameCHN["The One That Hunts"] = "狩猎者"
npcDescCHN["The One That Hunts"] = "不息的狩猎者，他永不放弃，永不投降"
-- horror
npcNameCHN["searing horror"] = "灼热恐魔"
npcDescCHN["searing horror"] = "听说你觉得灼眼恐魔还不够厉害？"
npcNameCHN["ravaging entropic rip"] = "肆虐的熵之裂口"
npcDescCHN["ravaging entropic rip"] = "撕裂了现实的一团奇怪的水晶。你不敢想它是从哪里来的。"
npcNameCHN["bursting entropic shard"] = "爆裂的熵之碎片"
npcDescCHN["bursting entropic shard"] = "一团发射出虚空能量的高大水晶。它的破裂处伸出触手抓向你。#{bold}#快跑!#{normal}#"
npcNameCHN["nethergate"] = "虚空之门"
npcDescCHN["nethergate"] = "散发着虚空能量的奇妙传送门，好像它本身是活着的。"
npcNameCHN["netherworm mass"] = "虚空蠕虫团"
npcDescCHN["netherworm mass"] = "一团令人厌恶的扭曲蠕虫，正在向你爬行过来。"
npcNameCHN["giant netherworm"] = "巨大虚空蠕虫"
npcDescCHN["giant netherworm"] = "一团令人厌恶的扭曲蠕虫，正在向你爬行过来。"
npcNameCHN["fearful symmetry"] = "恐怖的对称几何体"
npcDescCHN["fearful symmetry"] = "一团三角图形组成的充满恶意的漩涡。"
-- scourge-drake
npcNameCHN["scourge drake hatchling"] = "天谴龙幼仔"
npcDescCHN["scourge drake hatchling"] = "一只天谴龙幼仔。它本身并不强大，但是它们经常集体行动。"
npcNameCHN["scourge drake"] = "天谴龙"
npcDescCHN["scourge drake"] = "一只成年天谴龙，拥有致命的吐息和锋利的爪子。"
npcNameCHN["scourge wyrm"] = "天谴巨龙"
npcDescCHN["scourge wyrm"] = "一只年长且强大的天谴龙，拥有致命的吐息和锋利的爪子。"
-- Talent generated
npcNameCHN["decaying devourer"] = "腐败吞噬者"
npcDescCHN["devourer"] = "一只无头怪物，它有着圆润的体型和又粗又短的四肢。它的牙齿似乎占据了整个身体。"
npcNameCHN["hallucination"] = "幻象"
npcNameCHN["entropic maw"] = "熵之胃"
npcDescCHN["entropic maw"] = "卷须从怪物的嘴中伸出，正在寻找猎物。"
npcNameCHN["herald of oblivion"] = "湮灭使者"
npcDescCHN["herald of oblivion"] = "时空在这个巨大的生物的周围扭曲模糊，仿佛现实本身正在和它斗争。"
npcNameCHN["void skitterer"] = "虚空造物"
npcDescCHN["void skitterer"] = "一个蜷缩着卷须的奇怪生物，它不断地在空间中传送跳跃，不断接近它的猎物。"
npcNameCHN["void monolith"] = "虚无巨石"
npcDescCHN["void monolith"] = "这个奇异的长方体无视重力漂浮在空气中。它的形态似乎正在微妙地转换着，你感受到向着它走去的强烈愿望。"
npcNameCHN["hungering mouth"] = "饥饿巨口"
npcDescCHN["hungering mouth"] = "“来自深渊，吞噬四方。”"

npcNameCHN["steamgun turret"] = "蒸汽枪炮台"
npcDescCHN["steamgun turret"] = "装备着蒸汽枪的炮台"
npcNameCHN["flame turret"] = "火焰炮台"
npcDescCHN["flame turret"] = "装备着火焰喷射器的炮台"
npcNameCHN["medic turret"] = "医疗炮台"
npcDescCHN["medic turret"] = "释放医疗药剂的炮台"