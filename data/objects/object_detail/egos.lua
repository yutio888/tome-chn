...
-- ego " of purging" defined.
-- ego "inquisitor's " defined.
egosCHN[" of disruption"] = "分裂之"
-- ego " of the leech" defined.
-- ego " of dampening" defined.
-- Psionic Egos: 
-- ego "hateful " defined.
-- ego " of projection" defined.
