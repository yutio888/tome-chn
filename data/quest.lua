...
description = function(desc)
	...
	desc = string.gsub(desc,"You gave the Orb of Many Ways to Tannen to study while you look for the athame and diamond in Reknor."," 你 把 多 元 水 晶 球 交 给 了 泰 恩 进 一 步 研 究， 然 后 去 Reknor 继 续 寻 找 祭 祀 之 刃 和 水 晶。 ")
	desc = string.gsub(desc,"You kept the Orb of Many Ways despite Tannen's request to study it. You must now look for the athame and diamond in Reknor."," 虽 然 泰 恩 要 求 拿 来 研 究 但 是 你 还 是 把 多 元 水 晶 球 保 留 了 下 来， 下 一 步 你 必 须 去 瑞 库 纳 寻 找 祭 祀 之 刃 和 水 晶 了。 ")
	desc = string.gsub(desc,"You brought back the diamond and athame to Tannen who asked you to check the tower of Telmur, looking for a text of portals, although he is not sure it is even there. He told you to come back in a few days."," 你 把 祭 祀 之 刃 和 水 晶 带 回 给 泰 恩， 他 告 诉 你 去 泰 尔 玛 之 塔 看 看， 寻 找 那 里 的 传 送 密 文， 他 告 诉 几 天 之 后 再 回 去 找 他。 ")
	desc = string.gsub(desc,"You brought back the diamond and athame to Tannen who asked you to contact Zemekkys to ask some delicate questions."," 你 把 祭 祀 之 刃 和 水 晶 带 回 给 Tannen， 他 告 诉 你 去 找 伊 莫 克 斯 问 一 些 细 节 问 题。 ")
	desc = string.gsub(desc,"You brought back the diamond and athame to Tannen who asked you to come back in a few days."," 你 把 祭 祀 之 刃 和 水 晶 带 回 给 Tannen， 他 告 诉 你 过 几 天 再 去 找 他。 ")
	desc = string.gsub(desc,"Tannen has tricked you! He swapped the orb for a false one that brought you to a demonic plane. Find the exit, and get revenge!"," 泰 恩 把 你 耍 了！ 他 换 了 个 错 的 水 晶 球 给 你， 把 你 传 送 到 了 一 个 魔 法 时 空， 找 到 出 口 回 去 找 他 算 账！ ")
...
description = function(desc)
	...
	desc = string.gsub(desc,"The orc presence in the Far East has greatly been diminished by the loss of their leaders and the destruction of the Sorcerers. The free people of the Sunwall will be able to prosper and thrive on this land."," 丢 失 了 恶 魔 法 师 和 兽 人 首 领 的 兽 人 部 落 人 口 急 剧 减 少， 太 阳 堡 垒 的 人 们 得 以 这 片 大 陆 上 继 续 发 展、 繁 荣。 ")
...
description = function(desc)
	...
	desc = string.gsub(desc,"You have forced a recall while into an exploratory farportal zone, the farportal was rendered unusable in the process."," 你 在 一 个 传 送 区 域 听 到 了 一 个 回 音， 不 过 传 送 门 无 法 使 用。 ")
