questCHN["Mole Down, Two To Go"] = {
	...
	description = function(desc)
		...
		desc = desc:gsub("As you left the Gates of Morning in ruins you noticed a strange powerful tremor that seems to come from nearby.","当你离开晨曦之门的废墟，你注意到周围有一股强大的震感。")
