...
Talents.talents_def.T_GLYPH_OF_PARALYSIS.name= "麻痹圣印"
Talents.talents_def.T_GLYPH_OF_PARALYSIS.info= function(self, t)
...
Talents.talents_def.T_GLYPH_OF_REPULSION.name= "冲击圣印"
Talents.talents_def.T_GLYPH_OF_REPULSION.info= function(self, t)
...
Talents.talents_def.T_GLYPH_OF_EXPLOSION.name= "爆炸圣印"
Talents.talents_def.T_GLYPH_OF_EXPLOSION.info= function(self, t)
		local damage = t.getDamage(self, t)
		local duration = t.getDuration(self, t)
...
Talents.talents_def.T_GLYPH_OF_FATIGUE.name= "疲劳圣印"
Talents.talents_def.T_GLYPH_OF_FATIGUE.info= function(self, t)
