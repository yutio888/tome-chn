...
Talents.talents_def.T_ILLUMINATION.name= "照明"
Talents.talents_def.T_ILLUMINATION.info= function(self, t)
...
Talents.talents_def.T_SEARING_SIGHT.name= "灼烧"
Talents.talents_def.T_SEARING_SIGHT.info= function(self, t)
