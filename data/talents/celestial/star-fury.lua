...
Talents.talents_def.T_MOONLIGHT_RAY.name= "月光射线"
Talents.talents_def.T_MOONLIGHT_RAY.info= function(self, t)
		local damage = t.getDamage(self, t)
		return ([[召 唤 月 光 的 力 量 形 成 阴 影 射 线， 对 目 标 造 成 %0.2f 伤 害。 
		 受 法 术 强 度 影 响， 伤 害 有 额 外 加 成。]]):
		format(damDesc(self, DamageType.DARKNESS, damage))
	end
Talents.talents_def.T_SHADOW_BLAST.name= "阴影爆炸"
Talents.talents_def.T_SHADOW_BLAST.info= function(self, t)
		local damage = t.getDamage(self, t)
...
Talents.talents_def.T_TWILIGHT_SURGE.name= "光暗狂潮"
Talents.talents_def.T_TWILIGHT_SURGE.info= function(self, t)
...
Talents.talents_def.T_STARFALL.name= "星沉地动"
Talents.talents_def.T_STARFALL.info= function(self, t)
		local radius = self:getTalentRadius(t)
		local damage = t.getDamage(self, t)
