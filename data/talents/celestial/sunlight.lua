...
Talents.talents_def.T_SEARING_LIGHT.name= "灼热之矛"
Talents.talents_def.T_SEARING_LIGHT.info= function(self, t)
...
Talents.talents_def.T_SUN_FLARE.name= "日珥闪耀"
Talents.talents_def.T_SUN_FLARE.info= function(self, t)
...
Talents.talents_def.T_FIREBEAM.name= "阳炎喷射"
Talents.talents_def.T_FIREBEAM.info= function(self, t)
		local damage = t.getDamage(self, t)
		return ([[汲 取 太 阳 之 力 向 目 标 射 出 一 束 太 阳 真 火， 对 一 条 直 线 的 敌 人 造 成 %0.2f 火 焰 伤 害。 
		 受 法 术 强 度 影 响， 伤 害 有 额 外 加 成。]]):
		format(damDesc(self, DamageType.FIRE, damage))
	end
Talents.talents_def.T_SUNBURST.name= "日炎爆发"
Talents.talents_def.T_SUNBURST.info= function(self, t)
		local radius = self:getTalentRadius(t)
		local damage = t.getDamage(self, t)
