...
Talents.talents_def.T_WARP_BLADE.name = "扭曲灵刃"
...
Talents.talents_def.T_BLINK_BLADE.name = "闪烁灵刃"
Talents.talents_def.T_BLINK_BLADE.info = function(self, t)
		local damage = t.getDamage(self, t) * 100
...
Talents.talents_def.T_BLADE_SHEAR.name = "灵刃切变"
Talents.talents_def.T_BLADE_SHEAR.info = function(self, t)
		local damage = t.getDamage(self, t) * 100
		...
		:format(damage, shear, radius)
	end

Talents.talents_def.T_BLADE_WARD.name = "灵刃守卫"
Talents.talents_def.T_BLADE_WARD.info = function(self, t)
