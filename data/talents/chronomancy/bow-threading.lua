...
Talents.talents_def.T_SINGULARITY_ARROW.name = "奇点之矢"
Talents.talents_def.T_SINGULARITY_ARROW.info = function(self, t)
		local damage = t.getDamage(self, t) * 100
...
Talents.talents_def.T_ARROW_ECHOES.name = "灵矢回声"
...
Talents.talents_def.T_ARROW_THREADING.name = "螺旋灵矢"
Talents.talents_def.T_ARROW_THREADING.info = function(self, t)
