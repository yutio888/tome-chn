...
Talents.talents_def.T_SEAL_FATE.name = "命运封印"
...
Talents.talents_def.T_FATEWEAVER.name = "命运编织"
Talents.talents_def.T_FATEWEAVER.info = function(self, t)
...
Talents.talents_def.T_WEBS_OF_FATE.name = "命运之网"
