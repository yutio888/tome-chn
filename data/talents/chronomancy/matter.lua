...
Talents.talents_def.T_MATTER_WEAVING.info = function(self, t)
...
Talents.talents_def.T_MATERIALIZE_BARRIER.name = "物质屏障"
...
Talents.talents_def.T_DISINTEGRATION.info = function(self, t)
