...
Talents.talents_def.T_DIMENSIONAL_STEP.name = "空间跳跃"
Talents.talents_def.T_DIMENSIONAL_STEP.info = function(self, t)
...
Talents.talents_def.T_PHASE_PULSE.name = "相位脉冲"
