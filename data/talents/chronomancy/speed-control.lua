...
Talents.talents_def.T_CELERITY.name = "迅捷"
...
Talents.talents_def.T_TIME_DILATION.name = "时间膨胀"
...
Talents.talents_def.T_HASTE.name = "加速"
...
Talents.talents_def.T_TIME_STOP.name = "时间停止"
