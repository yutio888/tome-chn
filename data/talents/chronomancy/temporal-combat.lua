...
Talents.talents_def.T_FOLD_WARP.info = function(self, t)
		local chance = t.getChance(self, t)
		local damage = t.getDamage(self, t)
		local radius = self:getTalentRadius(t)
		local duration = t.getDuration(self, t)
...
Talents.talents_def.T_FOLD_GRAVITY.info = function(self, t)
		local chance = t.getChance(self, t)
		local damage = t.getDamage(self, t)
		local radius = self:getTalentRadius(t)
...
Talents.talents_def.T_WEAPON_FOLDING.info = function(self, t)
		local damage = t.getDamage(self, t)
		local chance = t.getChance(self, t)
...
Talents.talents_def.T_WEAPON_MANIFOLD.name = "多态武器"
