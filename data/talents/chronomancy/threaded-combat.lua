...
Talents.talents_def.T_THREAD_WALK.name = "空间行走"
Talents.talents_def.T_THREAD_WALK.info = function(self, t)
...
Talents.talents_def.T_BLENDED_THREADS.name = "混合螺旋"
...
Talents.talents_def.T_THREAD_THE_NEEDLE.name = "针型聚焦"
Talents.talents_def.T_THREAD_THE_NEEDLE.info = function(self, t)
		local damage = t.getDamage(self, t) * 100
...
Talents.talents_def.T_WARDEN_S_CALL.name = "守卫呼唤"
