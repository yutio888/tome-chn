...
Talents.talents_def.T_TIME_SKIP.name = "时间跳跃"
Talents.talents_def.T_TIME_SKIP.info = function(self, t)
		...
		伤 害 受 到 法 术 强 度 加 成 。	]]):format(damage, duration)
	end

Talents.talents_def.T_TEMPORAL_REPRIEVE.name = "时空避难所"
...
Talents.talents_def.T_ECHOES_FROM_THE_PAST.name = "往昔回响"
Talents.talents_def.T_ECHOES_FROM_THE_PAST.info = function(self, t)
