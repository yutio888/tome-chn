...
Talents.talents_def.T_STRIPPED_LIFE.name = "生命剥夺"
Talents.talents_def.T_STRIPPED_LIFE.info = function(self, t)
...
Talents.talents_def.T_GRIM_FUTURE.name = "无情未来"
Talents.talents_def.T_GRIM_FUTURE.info = function(self, t)
