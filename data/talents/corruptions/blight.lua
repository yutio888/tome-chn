...
Talents.talents_def.T_DARK_RITUAL.name= "黑暗仪式"
Talents.talents_def.T_DARK_RITUAL.info= function(self, t)
		return ([[增 加 %d%% 法 术 暴 击 倍 率。 
		 受 法 术 强 度 影 响， 倍 率 有 额 外 加 成。]]):
		format(self:combatTalentSpellDamage(t, 20, 60))
	end
Talents.talents_def.T_CORRUPTED_NEGATION.name= "能量腐蚀"
Talents.talents_def.T_CORRUPTED_NEGATION.info= function(self, t)
...
Talents.talents_def.T_CORROSIVE_WORM.name= "腐蚀蠕虫"
Talents.talents_def.T_CORROSIVE_WORM.info= function(self, t)
...
Talents.talents_def.T_POISON_STORM.name= "剧毒风暴"
