...
Talents.talents_def.T_CURSE_OF_DEFENSELESSNESS.name= "衰竭诅咒"
Talents.talents_def.T_CURSE_OF_DEFENSELESSNESS.info= function(self, t)
		return ([[诅 咒 目 标， 减 少 它 %d 点 闪 避 和 所 有 豁 免， 持 续 10 回 合。 
		 受 法 术 强 度 影 响， 效 果 有 额 外 加 成。]]):format(self:combatTalentSpellDamage(t, 30, 60))
	end
Talents.talents_def.T_CURSE_OF_IMPOTENCE.name= "虚弱诅咒"
Talents.talents_def.T_CURSE_OF_IMPOTENCE.info= function(self, t)
		return ([[诅 咒 目 标， 减 少 它 %d%% 所 有 伤 害， 持 续 10 回 合。 
		 受 法 术 强 度 影 响， 伤 害 值 有 额 外 减 少。]]):format(t.imppower(self,t))
	end
Talents.talents_def.T_CURSE_OF_DEATH.name= "死亡诅咒"
Talents.talents_def.T_CURSE_OF_DEATH.info= function(self, t)
...
Talents.talents_def.T_CURSE_OF_VULNERABILITY.name= "弱点诅咒"
Talents.talents_def.T_CURSE_OF_VULNERABILITY.info= function(self, t)
