...
t_talent_name["T_DEMON_SEED_FIERY_CLEANSING"] = "火焰净化"
talentInfoCHN["T_DEMON_SEED_FIERY_CLEANSING"] = function(self, t)
		return ([[消 耗 10%% 最 大 生 命 值，解 除 至 多 %d 个 负 面 状 态。]]):
		format(t.getNb(self, t))
	end


t_talent_name["T_DEMON_SEED_FARSTRIKE"] = "远程打击"
talentInfoCHN["T_DEMON_SEED_FARSTRIKE"] = function(self, t)
...
talentInfoCHN["T_DEMON_SEED_ACIDIC_BATH"] = function(self, t)
...
t_talent_name["T_DEMON_SEED_BLIGHTED_PATH"] = "枯萎之路"
talentInfoCHN["T_DEMON_SEED_BLIGHTED_PATH"] = function(self, t)
...
t_talent_name["T_DEMON_SEED_CORRUPT_LIGHT"] = "腐化之光"
talentInfoCHN["T_DEMON_SEED_CORRUPT_LIGHT"] = function(self, t)
...
t_talent_name["T_DEMON_SEED_SHADOWMELD"] = "暗影融合"
talentInfoCHN["T_DEMON_SEED_SHADOWMELD"] = function(self, t)
...
t_talent_name["T_DEMON_SEED_FIERY_PORTAL"] = "火焰传送门"
talentInfoCHN["T_DEMON_SEED_FIERY_PORTAL"] = function(self, t)
		return ([[制 造 两 个 连 接 在 一 起 的 传 送 门 ， 持 续 %d 回 合。]]):
		format(t.getDuration(self, t))
	end


t_talent_name["T_DEMON_SEED_DOOM_TENDRILS"] = "末日触须"
talentInfoCHN["T_DEMON_SEED_DOOM_TENDRILS"] = function(self, t)
...
t_talent_name["T_DEMON_SEED_DOOMED_NATURE"] = "自然末日"
talentInfoCHN["T_DEMON_SEED_DOOMED_NATURE"] = function(self, t)
...
t_talent_name["T_DEMON_SEED_ACID_BURST"] = "酸性爆发"
talentInfoCHN["T_DEMON_SEED_ACID_BURST"]  = function(self, t)
...
t_talent_name["T_DEMON_SEED_ACID_CONE"] = "锥形酸液"
talentInfoCHN["T_DEMON_SEED_ACID_CONE"] = function(self, t)
		local damage = t.getDamage(self, t)
...
t_talent_name["T_DEMON_SEED_ARMOURED_LEVIATHAN"] = "重装上阵"
talentInfoCHN["T_DEMON_SEED_ARMOURED_LEVIATHAN"] = function(self, t)
		return ([[你 利 用 盾 牌 来 强 化 自 身 ，力 量 和 魔 法 增 加 10%%格 挡 值 ,持 续 %d 回 合 。]]):
		format(t.getDuration(self, t))
	end

t_talent_name["T_DEMON_SEED_FLASH_BLOCK"] = "瞬间格挡"
talentInfoCHN["T_DEMON_SEED_FLASH_BLOCK"] = function(self, t)
		return ([[在 闪 电 般 的 速 度 中 ，你 瞬 间 举 起 盾 牌 格 挡 。]]):
		format()
	end

t_talent_name["T_DEMON_SEED_BLACKICE"] = "黑冰"
talentInfoCHN["T_DEMON_SEED_BLACKICE"] = function(self, t)
