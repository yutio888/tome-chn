...
Talents.talents_def.T_DEMON_SEED_FIRE_BOLTS.name = "近战火球"
Talents.talents_def.T_DEMON_SEED_FIRE_BOLTS.info = function(self, t)
...
Talents.talents_def.T_DEMON_SEED_FIERY_CLEANSING.name = "火焰净化"
Talents.talents_def.T_DEMON_SEED_FIERY_CLEANSING.info = function(self, t)
		return ([[消 耗 10%% 最 大 生 命 值，解 除 至 多 %d 个 负 面 状 态。]]):
		format(t.getNb(self, t))
	end


Talents.talents_def.T_DEMON_SEED_FARSTRIKE.name = "远程打击"
Talents.talents_def.T_DEMON_SEED_FARSTRIKE.info = function(self, t)
		local range = self:getTalentRange(t)
		return ([[扔 出 武 器 攻 击 远 处 敌 人，造 成 %d%% 武 器 伤 害 。]]):
		format(t.getDamage(self, t)*100)
	end

Talents.talents_def.T_DEMON_SEED_CORROSIVE_SLASHES.name = "腐蚀鞭笞"
Talents.talents_def.T_DEMON_SEED_CORROSIVE_SLASHES.info = function(self, t)
		return ([[用 酸 液 覆 盖 武 器，近 战 伤 害 转 变 为 酸 性。
		近 战 攻 击 获 得 %d 护 甲 穿 透。]]):
		format(t.getArmorPen(self, t))
	end

Talents.talents_def.T_DEMON_SEED_ACIDIC_BATH.name = "酸浴"
Talents.talents_def.T_DEMON_SEED_ACIDIC_BATH.info = function(self, t)
...
Talents.talents_def.T_DEMON_SEED_BLIGHTED_PATH.name = "枯萎之路"
Talents.talents_def.T_DEMON_SEED_BLIGHTED_PATH.info = function(self, t)
...
Talents.talents_def.T_DEMON_SEED_CORRUPT_LIGHT.name = "腐化之光"
Talents.talents_def.T_DEMON_SEED_CORRUPT_LIGHT.info = function(self, t)
...
Talents.talents_def.T_DEMON_SEED_SHADOWMELD.name = "暗影融合"
Talents.talents_def.T_DEMON_SEED_SHADOWMELD.info = function(self, t)
...
Talents.talents_def.T_DEMON_SEED_BLOOD_SHIELD.name = "鲜血护盾"
Talents.talents_def.T_DEMON_SEED_BLOOD_SHIELD.info = function(self, t)
...
Talents.talents_def.T_DEMON_SEED_SILENCE.name = "沉默"
Talents.talents_def.T_DEMON_SEED_SILENCE.info = function(self, t)
		return ([[腐 化 目 标 ， 使 之 沉 默 %d 回 合。]]):
		format(t.getDuration(self, t))
	end


Talents.talents_def.T_DEMON_SEED_FIERY_PORTAL.name = "火焰传送门"
Talents.talents_def.T_DEMON_SEED_FIERY_PORTAL.info = function(self, t)
		return ([[制 造 两 个 连 接 在 一 起 的 传 送 门 ， 持 续 %d 回 合。]]):
		format(t.getDuration(self, t))
	end


Talents.talents_def.T_DEMON_SEED_DOOM_TENDRILS.name = "末日触须"
Talents.talents_def.T_DEMON_SEED_DOOM_TENDRILS.info = function(self, t)
...
Talents.talents_def.T_DEMON_SEED_ACID_BURST.name = "酸性爆发"
Talents.talents_def.T_DEMON_SEED_ACID_BURST.info  = function(self, t)
...
Talents.talents_def.T_DEMON_SEED_ACID_CONE.name = "锥形酸液"
...
Talents.talents_def.T_DEMON_SEED_FLASH_BLOCK.name = "瞬间格挡"
Talents.talents_def.T_DEMON_SEED_FLASH_BLOCK.info = function(self, t)
