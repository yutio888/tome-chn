...
Talents.talents_def.T_SURGE_OF_POWER.name = "力量之潮"
Talents.talents_def.T_SURGE_OF_POWER.info = function(self, t)
...
Talents.talents_def.T_DEMONIC_BLOOD.name = "恶魔之血"
Talents.talents_def.T_DEMONIC_BLOOD.info = function(self, t)
