...
Talents.talents_def.T_HARDENED_CORE.name = "硬化之核"
Talents.talents_def.T_HARDENED_CORE.info = function(self, t)
...
Talents.talents_def.T_DEMONIC_MADNESS.name = "疯狂旋转"
Talents.talents_def.T_DEMONIC_MADNESS.info = function(self, t)
