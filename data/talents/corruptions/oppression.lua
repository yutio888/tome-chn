...
Talents.talents_def.T_HORRIFYING_BLOWS.name = "恐惧打击"
Talents.talents_def.T_HORRIFYING_BLOWS.info = function(self, t)
...
Talents.talents_def.T_MASS_HYSTERIA.name = "恐惧之潮"
Talents.talents_def.T_MASS_HYSTERIA.info = function(self, t)
...
Talents.talents_def.T_FEARFEAST.name = "恐惧盛宴"
Talents.talents_def.T_FEARFEAST.info = function(self, t)
...
Talents.talents_def.T_HOPE_WANES.name = "绝望碾压"
Talents.talents_def.T_HOPE_WANES.info = function(self, t)
