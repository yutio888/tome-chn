...
Talents.talents_def.T_CORRUPTED_STRENGTH.name= "堕落力量"
Talents.talents_def.T_CORRUPTED_STRENGTH.info= function(self, t)
...
Talents.talents_def.T_BLOODLUST.name= "嗜血杀戮"
Talents.talents_def.T_BLOODLUST.info= function(self, t)
...
Talents.talents_def.T_CARRIER.name= "携带者"
Talents.talents_def.T_CARRIER.info= function(self, t)
...
Talents.talents_def.T_ACID_BLOOD.name= "酸性血液"
Talents.talents_def.T_ACID_BLOOD.info= function(self, t)
