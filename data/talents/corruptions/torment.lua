...
Talents.talents_def.T_WILLFUL_TORMENTER.name= "施虐之心"
Talents.talents_def.T_WILLFUL_TORMENTER.info= function(self, t)
		return ([[你 将 精 神 集 中 于 一 个 目 标： 摧 毁 所 有 敌 人。 
		 增 加 你 %d 点 活 力 上 限。]]):
		format(t.VimBonus(self, t))
	end
Talents.talents_def.T_BLOOD_LOCK.name= "鲜血禁锢"
Talents.talents_def.T_BLOOD_LOCK.info= function(self, t)
		return ([[掌 控 敌 人 的 血 液 和 肉 体。 在 2 码 范 围 内， 任 何 被 鲜 血 禁 锢 攻 击 到 的 敌 人 的 治 疗 或 回 复 将 不 能 超 过 当 前 生 命 值， 持 续 %d 回 合。]]):
		format(t.getDuration(self, t))
	end
Talents.talents_def.T_OVERKILL.name= "赶尽杀绝"
Talents.talents_def.T_OVERKILL.info= function(self, t)
...
Talents.talents_def.T_BLOOD_VENGEANCE.name= "血之复仇"
Talents.talents_def.T_BLOOD_VENGEANCE.info= function(self, t)
