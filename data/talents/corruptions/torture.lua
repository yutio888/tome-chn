...
Talents.talents_def.T_ABDUCTION.name = "锁魂之链"
Talents.talents_def.T_ABDUCTION.info = function(self, t)
...
Talents.talents_def.T_FIERY_TORMENT.name = "灼魂之罚"
Talents.talents_def.T_FIERY_TORMENT.info = function(self, t)
