...
Talents.talents_def.T_SOUL_ROT.name= "灵魂腐蚀"
Talents.talents_def.T_SOUL_ROT.info= function(self, t)
...
Talents.talents_def.T_VIMSENSE.name= "活力感知"
Talents.talents_def.T_VIMSENSE.info= function(self, t)
...
Talents.talents_def.T_LEECH.name= "活力吸取"
Talents.talents_def.T_LEECH.info= function(self, t)
		return ([[每 当 被 活 力 感 知 发 现 的 敌 人 攻 击 你 时， 你 回 复 %0.2f 活 力 值 和 %0.2f 生 命 值。]]):
		format(t.getVim(self,t),t.getHeal(self,t))
	end
Talents.talents_def.T_DARK_PORTAL.name= "黑暗之门"
Talents.talents_def.T_DARK_PORTAL.info= function(self, t)
