...
Talents.talents_def.T_SHADOW_LEASH.name= "暗影束缚"
Talents.talents_def.T_SHADOW_LEASH.info= function(self, t)
		local duration = t.getDuration(self, t)
		return ([[使 你 的 武 器 立 刻 转 化 为 暗 影 之 缚 形 态， 夺 取 目 标 武 器， 缴 械 目 标 %d 回 合。 
		 受 命 中 影 响， 技 能 命 中 率 有 额 外 加 成。]]):
		format(duration)
	end
Talents.talents_def.T_SHADOW_AMBUSH.name= "暗影伏击"
Talents.talents_def.T_SHADOW_AMBUSH.info= function(self, t)
		local duration = t.getDuration(self, t)
		return ([[你 向 目 标 甩 出 1 道 影 之 绳 索， 将 目 标 拉 向 你 并 沉 默 它 %d 回 合， 同 时 眩 晕 目 标 2 回 合。 
		 受 命 中 影 响， 技 能 命 中 率 有 额 外 加 成。]]):
		format(duration)
	end
Talents.talents_def.T_AMBUSCADE.name= "影分身"
Talents.talents_def.T_AMBUSCADE.info= function(self, t)
...
Talents.talents_def.T_SHADOW_VEIL.name= "暗影之舞"
Talents.talents_def.T_SHADOW_VEIL.info= function(self, t)
