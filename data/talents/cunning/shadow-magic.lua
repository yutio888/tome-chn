...
Talents.talents_def.T_SHADOW_COMBAT.name= "影之格斗"
Talents.talents_def.T_SHADOW_COMBAT.info= function(self, t)
...
Talents.talents_def.T_SHADOW_CUNNING.name= "影之狡诈"
Talents.talents_def.T_SHADOW_CUNNING.info= function(self, t)
		local spellpower = t.getSpellpower(self, t)
		return ([[你 的 充 分 准 备 提 高 了 你 的 魔 法 运 用 能 力。 增 加 相 当 于 你 %d%% 灵 巧 的 法 术 强 度。]]):
		format(spellpower)
	end
Talents.talents_def.T_SHADOW_FEED.name= "暗影充能"
Talents.talents_def.T_SHADOW_FEED.info= function(self, t)
...
Talents.talents_def.T_SHADOWSTEP.name= "暗影突袭"
Talents.talents_def.T_SHADOWSTEP.info= function(self, t)
