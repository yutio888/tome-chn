...
Talents.talents_def.T_DEFILING_TOUCH.name= "诅咒之触"
Talents.talents_def.T_DEFILING_TOUCH.info= function(self, t)
		return ([[
...
Talents.talents_def.T_DARK_GIFTS.name= "黑暗礼物"
Talents.talents_def.T_DARK_GIFTS.info= function(self, t)
...
Talents.talents_def.T_RUINED_EARTH.name= "毁灭大地"
Talents.talents_def.T_RUINED_EARTH.info= function(self, t)
...
Talents.talents_def.T_CHOOSE_CURSED_SENTRY.name = "选择诅咒守卫"
Talents.talents_def.T_CHOOSE_CURSED_SENTRY.info= function(self, t) return [[选择你的诅咒护卫。]] end
Talents.talents_def.T_CURSED_SENTRY.name= "诅咒护卫"
Talents.talents_def.T_CURSED_SENTRY.info= function(self, t)
		local duration = t.getDuration(self, t)
