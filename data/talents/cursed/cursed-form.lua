...
Talents.talents_def.T_UNNATURAL_BODY.name= "诅咒之体"
Talents.talents_def.T_UNNATURAL_BODY.info= function(self, t)
...
Talents.talents_def.T_RELENTLESS.name= "鲜血渴望"
Talents.talents_def.T_RELENTLESS.info= function(self, t)
		return ([[对 鲜 血 的 渴 望 控 制 了 你 的 行 为。 增 加 +%d%% 混 乱、 恐 惧、 击 退 和 震 慑 免 疫。]]):format(t.getImmune(self, t)*100)
	end
Talents.talents_def.T_SEETHE.name= "狂热沸腾"
Talents.talents_def.T_SEETHE.info= function(self, t)
...
Talents.talents_def.T_GRIM_RESOLVE.name= "冷酷决心"
Talents.talents_def.T_GRIM_RESOLVE.info= function(self, t)
