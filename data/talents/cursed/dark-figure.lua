...
Talents.talents_def.T_RADIANT_FEAR.name= "恐惧辉耀"
Talents.talents_def.T_RADIANT_FEAR.info= function(self, t)
		local radius = t.getRadius(self, t)
		local duration = t.getDuration(self, t)
		return ([[恐 惧 %d 码 半 径 内 的 目 标 以 驱 逐 他 们， 持 续 %d 回 合。]]):format(radius, duration)
	end
Talents.talents_def.T_SUPPRESSION.name= "诅咒抑制"
Talents.talents_def.T_SUPPRESSION.info= function(self, t)
		local percent = t.getPercent(self, t)
		return ([[长 年 对 抗 诅 咒 的 经 历 使 你 能 够 自 我 控 制。 大 部 分 非 魔 法 效 果 的 持 续 时 间 减 少 %d%% 。]]):format(percent)
	end
Talents.talents_def.T_CRUEL_VIGOR.name= "残酷活力"
Talents.talents_def.T_CRUEL_VIGOR.info= function(self, t)
		local speed = t.getSpeed(self, t)
		local duration = t.getDuration(self, t)
		return ([[你 被 周 围 的 死 亡 所 鼓 舞。 你 每 杀 死 一 个 单 位 提 供 你 %d%% 的 速 度， 持 续 %d 更 多 回 合。]]):format(100 + speed, duration)
	end
Talents.talents_def.T_PITY.name= "怜悯"
Talents.talents_def.T_PITY.info= function(self, t)
