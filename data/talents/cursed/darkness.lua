...
Talents.talents_def.T_CREEPING_DARKNESS.name= "黑暗之雾"
Talents.talents_def.T_CREEPING_DARKNESS.info = function(self, t)
...
Talents.talents_def.T_DARK_VISION.name= "黑暗视觉"
Talents.talents_def.T_DARK_VISION.info= function(self, t)
...
Talents.talents_def.T_DARK_TORRENT.name= "黑暗迸发"
Talents.talents_def.T_DARK_TORRENT.info= function(self, t)
		local damage = t.getDamage(self, t)
		local damageIncrease = getDamageIncrease(self)
...
Talents.talents_def.T_DARK_TENDRILS.name= "黑暗触手"
Talents.talents_def.T_DARK_TENDRILS.info= function(self, t)
