...
Talents.talents_def.T_WEAKNESS.name= "黑暗衰竭"
Talents.talents_def.T_WEAKNESS.info= function(self, t)
		local chance = t.getChance(self, t)
		local duration = t.getDuration(self, t)
...
Talents.talents_def.T_DISMAY.name= "黑暗痛苦"
Talents.talents_def.T_DISMAY.info= function(self, t)
		local chance = t.getChance(self, t)
		local duration = t.getDuration(self, t)
		local mindpowerChange = gloomTalentsMindpower(self)
...
Talents.talents_def.T_SANCTUARY.name= "庇护光环"
Talents.talents_def.T_SANCTUARY.info= function(self, t)
