...
Talents.talents_def.T_SHADOW_SENSES.name= "阴影感知"
Talents.talents_def.T_SHADOW_SENSES.info= function(self, t)
		return ([[ 你 的 意 识 延 伸 到 阴 影 上 。
		 你 能 清 晰 的 感 知 到 阴 影 的 位 置 ， 同 时 还 能 感 知 到 阴 影 视 野 %d 码 范 围 内 的 敌 人 。]])
		:format(self:getTalentRange(t))
	end
Talents.talents_def.T_SHADOW_EMPATHY.name= "阴影链接"
Talents.talents_def.T_SHADOW_EMPATHY.info= function(self, t)
...
Talents.talents_def.T_SHADOW_TRANSPOSITION.name= "阴影换位"
Talents.talents_def.T_SHADOW_TRANSPOSITION.info= function(self, t)
...
Talents.talents_def.T_SHADOW_DECOY.name= "阴影诱饵"
Talents.talents_def.T_SHADOW_DECOY.info= function(self, t)
