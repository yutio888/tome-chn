...
Talents.talents_def.T_SHADOW_FADE.name= "隐形"
Talents.talents_def.T_SHADOW_FADE.info= function(self, t)
		return ([[你 从 视 线 中 消 失 并 无 敌， 直 到 下 一 回 合 开 始。]])
	end
Talents.talents_def.T_SHADOW_PHASE_DOOR.name= "相位之门"
Talents.talents_def.T_SHADOW_PHASE_DOOR.info= function(self, t)
		return ([[小 范 围 内 将 你 传 送 一 段 距 离。]])
	end
Talents.talents_def.T_SHADOW_BLINDSIDE.name= "灵异打击"
Talents.talents_def.T_SHADOW_BLINDSIDE.info= function(self, t)
...
Talents.talents_def.T_SHADOW_LIGHTNING.name= "暗影闪电"
Talents.talents_def.T_SHADOW_LIGHTNING.info= function(self, t)
...
Talents.talents_def.T_SHADOW_FLAMES.name= "暗影之火"
Talents.talents_def.T_SHADOW_FLAMES.info= function(self, t)
		local damage = t.getDamage(self, t)
		return ([[用 火 焰 灼 烧 你 的 目 标 造 成 %0.2f 伤 害。 
		 受 魔 法 影 响， 伤 害 有 额 外 加 成。]]):
		format(damDesc(self, DamageType.FIREBURN, damage))
	end
Talents.talents_def.T_SHADOW_REFORM.name= "重组"
Talents.talents_def.T_SHADOW_REFORM.info= function(self, t)
		local chance = t.getChance(self, t)
		return ([[当 阴 影 受 到 伤 害 或 被 杀 死， 有 %d%% 几 率 重 组 并 免 受 伤 害。]]):format(chance)
	end
Talents.talents_def.T_CALL_SHADOWS.name= "召唤阴影"
Talents.talents_def.T_CALL_SHADOWS.info= function(self, t)
...
Talents.talents_def.T_SHADOW_WARRIORS.name= "阴影战士"
Talents.talents_def.T_SHADOW_WARRIORS.info= function(self, t)
...
Talents.talents_def.T_SHADOW_MAGES.info= function(self, t)
...
Talents.talents_def.T_FOCUS_SHADOWS.name= "聚集阴影"
Talents.talents_def.T_FOCUS_SHADOWS.info= function(self, t)
