...
Talents.talents_def.T_MEDITATION.name= "冥想"
Talents.talents_def.T_MEDITATION.info= function(self, t)
...
Talents.talents_def.T_NATURE_TOUCH.name= "自然之触"
Talents.talents_def.T_NATURE_TOUCH.info= function(self, t)
...
Talents.talents_def.T_EARTH_S_EYES.name= "大地之眼"
Talents.talents_def.T_EARTH_S_EYES.info= function(self, t)
...
Talents.talents_def.T_NATURE_S_BALANCE.name= "自然平衡"
Talents.talents_def.T_NATURE_S_BALANCE.info= function(self, t)
