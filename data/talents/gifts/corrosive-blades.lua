...
Talents.talents_def.T_ACIDBEAM.name= "酸性射线"
Talents.talents_def.T_ACIDBEAM.info= function(self, t)
...
Talents.talents_def.T_CORROSIVE_NATURE.name= "自然腐蚀"
Talents.talents_def.T_CORROSIVE_NATURE.info= function(self, t)
...
Talents.talents_def.T_CORROSIVE_SEEDS.name= "腐蚀之种"
Talents.talents_def.T_CORROSIVE_SEEDS.info= function(self, t)
		local dam = t.getDamage(self, t)
...
Talents.talents_def.T_ACIDIC_SOIL.name= "酸化大地"
Talents.talents_def.T_ACIDIC_SOIL.info= function(self, t)
