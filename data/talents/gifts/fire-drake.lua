...
Talents.talents_def.T_WING_BUFFET.name= "龙翼飓风"
Talents.talents_def.T_WING_BUFFET.info= function(self, t)
...
Talents.talents_def.T_BELLOWING_ROAR.name= "怒意咆哮"
Talents.talents_def.T_BELLOWING_ROAR.info= function(self, t)
...
Talents.talents_def.T_DEVOURING_FLAME.name= "火焰吞噬"
Talents.talents_def.T_DEVOURING_FLAME.info= function(self, t)
...
Talents.talents_def.T_FIRE_BREATH.name= "火焰吐息"
Talents.talents_def.T_FIRE_BREATH.info= function(self, t)
