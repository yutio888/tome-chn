...
Talents.talents_def.T_WILD_GROWTH.name= "野性生长"
Talents.talents_def.T_WILD_GROWTH.info= function(self, t)
		local dur = t.getDur(self, t)
		return ([[使 你 自 身 周 围 环 绕 无 数 微 不 可 见、 有 治 疗 作 用 的 孢 子。 
		 作 用 于 你 身 上 的 任 何 回 复 效 果， 会 增 加 +%d 回 合 持 续 时 间。]]):
		format(dur)
	end
Talents.talents_def.T_FUNGAL_GROWTH.name= "真菌生长"
Talents.talents_def.T_FUNGAL_GROWTH.info= function(self, t)
...
Talents.talents_def.T_ANCESTRAL_LIFE.name= "原始生命"
Talents.talents_def.T_ANCESTRAL_LIFE.info= function(self, t)
...
Talents.talents_def.T_SUDDEN_GROWTH.name= "疯狂成长"
Talents.talents_def.T_SUDDEN_GROWTH.info= function(self, t)
