...
Talents.talents_def.T_PRISMATIC_SLASH.name= "五灵挥击"
Talents.talents_def.T_PRISMATIC_SLASH.info= function(self, t)
...
Talents.talents_def.T_CHROMATIC_FURY.info= function(self, t)
