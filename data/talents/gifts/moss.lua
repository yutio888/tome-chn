...
Talents.talents_def.T_GRASPING_MOSS.name= "减速苔藓"
Talents.talents_def.T_GRASPING_MOSS.info= function(self, t)
...
Talents.talents_def.T_NOURISHING_MOSS.name= "生命苔藓"
Talents.talents_def.T_NOURISHING_MOSS.info= function(self, t)
		local damage = t.getDamage(self, t)
		local duration = t.getDuration(self, t)
...
Talents.talents_def.T_SLIPPERY_MOSS.name= "光滑苔藓"
Talents.talents_def.T_SLIPPERY_MOSS.info= function(self, t)
		local damage = t.getDamage(self, t)
		local duration = t.getDuration(self, t)
...
Talents.talents_def.T_HALLUCINOGENIC_MOSS.name= "迷幻苔藓"
Talents.talents_def.T_HALLUCINOGENIC_MOSS.info= function(self, t)
		local damage = t.getDamage(self, t)
		local duration = t.getDuration(self, t)
