...
Talents.talents_def.T_MUCUS.name= "粘液"
Talents.talents_def.T_MUCUS.info= function(self, t)
...
Talents.talents_def.T_ACID_SPLASH.name= "酸液飞溅"
Talents.talents_def.T_ACID_SPLASH.info= function(self, t)
		local dam = t.getDamage(self, t)
...
Talents.talents_def.T_MUCUS_OOZE_SPIT.name= "粘液喷吐"
Talents.talents_def.T_MUCUS_OOZE_SPIT.info= function(self, t)
...
Talents.talents_def.T_LIVING_MUCUS.name= "粘液伙伴"
Talents.talents_def.T_LIVING_MUCUS.info= function(self, t)
...
Talents.talents_def.T_OOZEWALK.name= "粘液探戈"
Talents.talents_def.T_OOZEWALK.info= function(self, t)
