...
Talents.talents_def.T_LIGHTNING_SPEED.name= "闪电加速"
Talents.talents_def.T_LIGHTNING_SPEED.info= function(self, t)
...
Talents.talents_def.T_STATIC_FIELD.name= "静电力场"
...
Talents.talents_def.T_TORNADO.name= "龙卷风"
Talents.talents_def.T_TORNADO.info= function(self, t)
		...
		return ([[召 唤 1 个 龙 卷 风， 缓 慢 跟 随 目 标。 
		 ...
		 当 它 到 达 目 标 时， 它 会 在 1 码 半 径 范 围 内 爆 炸 并 造 成 %0.2f 闪 电 伤 害， %0.2f 物 理 伤 害。 所 有 受 到 影 响 的 生 物 都 会 被 击 退 并 且 目 标 会 被 震 慑 %d 回 合，爆 炸 不 会 伤 害 释 放 者。 
...
Talents.talents_def.T_LIGHTNING_BREATH.name= "闪电吐息"
Talents.talents_def.T_LIGHTNING_BREATH.info= function(self, t)
