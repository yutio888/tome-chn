...
Talents.talents_def.T_RAGE.name= "狂暴"
Talents.talents_def.T_RAGE.info= function(self, t)
		return ([[提 升 1 只 召 唤 兽 的 杀 戮 速 度， 增 加 它 %d 点 所 有 属 性， 持 续 10 回 合。]]):format(self:combatTalentMindDamage(t, 10, 100)/4)
	end
Talents.talents_def.T_DETONATE.name= "引爆"
Talents.talents_def.T_DETONATE.info= function(self, t)
