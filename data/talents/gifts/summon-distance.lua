...
Talents.talents_def.T_RITCH_FLAMESPITTER_BOLT.name= "火焰喷射"
Talents.talents_def.T_RITCH_FLAMESPITTER_BOLT.info= function(self, t)
...
Talents.talents_def.T_FLAME_FURY.name= "火焰之怒"
Talents.talents_def.T_FLAME_FURY.info= function(self, t)
...
Talents.talents_def.T_ACID_BREATH.name= "酸液吐息"
Talents.talents_def.T_ACID_BREATH.info= function(self, t)
...
Talents.talents_def.T_LIGHTNING_BREATH_HYDRA.name= "闪电吐息"
Talents.talents_def.T_LIGHTNING_BREATH_HYDRA.info= function(self, t)
...
Talents.talents_def.T_POISON_BREATH.name= "毒性吐息"
Talents.talents_def.T_POISON_BREATH.info= function(self, t)
...
Talents.talents_def.T_WINTER_S_FURY.name= "严冬之怒"
Talents.talents_def.T_WINTER_S_FURY.info= function(self, t)
		local damage = t.getDamage(self, t)
...
Talents.talents_def.T_RITCH_FLAMESPITTER.name= "契约：里奇之焰"
Talents.talents_def.T_RITCH_FLAMESPITTER.info= function(self, t)
...
Talents.talents_def.T_HYDRA.name= "契约：三头蛇"
Talents.talents_def.T_HYDRA.info= function(self, t)
		local incStats = t.incStats(self, t, true)
...
Talents.talents_def.T_RIMEBARK.name= "契约：雾凇"
Talents.talents_def.T_RIMEBARK.info= function(self, t)
		local incStats = t.incStats(self, t, true)
...
Talents.talents_def.T_FIRE_DRAKE.name= "契约：火龙"
Talents.talents_def.T_FIRE_DRAKE.info= function(self, t)
		local incStats = t.incStats(self, t, true)
