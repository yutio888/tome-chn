...
Talents.talents_def.T_WAR_HOUND.name= "契约：战争猎犬"
Talents.talents_def.T_WAR_HOUND.info= function(self, t)
...
Talents.talents_def.T_JELLY.name= "契约：果冻怪"
Talents.talents_def.T_JELLY.info= function(self, t)
		local incStats = t.incStats(self, t, true)
...
Talents.talents_def.T_MINOTAUR.name= "契约：米诺陶"
Talents.talents_def.T_MINOTAUR.info= function(self, t)
		local incStats = t.incStats(self, t, true)
...
Talents.talents_def.T_STONE_GOLEM.name= "契约：岩石傀儡"
Talents.talents_def.T_STONE_GOLEM.info= function(self, t)
		local incStats = t.incStats(self, t,true)
