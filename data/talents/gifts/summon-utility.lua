...
Talents.talents_def.T_TAUNT.name= "嘲讽"
Talents.talents_def.T_TAUNT.info= function(self, t)
		return ([[强 制 %d 码 范 围 内 的 所 有 敌 对 目 标 攻 击 你。]]):format(self:getTalentRadius(t))
	end
Talents.talents_def.T_SHELL_SHIELD.name= "甲壳护盾"
Talents.talents_def.T_SHELL_SHIELD.info= function(self, t)
		return ([[隐 藏 在 你 的 甲 壳 下， 增 加 %d%% 全 体 伤 害 抗 性 ， 持 续 %d 回 合。]]):format(t.resistPower(self, t), t.getDuration(self, t))
	end
Talents.talents_def.T_SPIDER_WEB.name= "蜘蛛之网"
Talents.talents_def.T_SPIDER_WEB.info= function(self, t)
		return ([[朝 你 的 目 标 投 掷 一 个 网， 若 目 标 被 击 中 则 被 困 在 原 地 %d 回 合。]]):format(t.getDuration(self, t))
	end
Talents.talents_def.T_TURTLE.name= "契约：乌龟"
Talents.talents_def.T_TURTLE.info= function(self, t)
...
Talents.talents_def.T_SPIDER.name= "契约：蜘蛛"
Talents.talents_def.T_SPIDER.info= function(self, t)
		local incStats = t.incStats(self, t,true)
...
Talents.talents_def.T_FRANTIC_SUMMONING.name= "疯狂召唤"
Talents.talents_def.T_FRANTIC_SUMMONING.info= function(self, t)
...
Talents.talents_def.T_SUMMON_CONTROL.name= "精确控制"
Talents.talents_def.T_SUMMON_CONTROL.info= function(self, t)
