...
Talents.talents_def.T_RESILIENCE_OF_THE_DOOMED.name = "强韧"
Talents.talents_def.T_RESILIENCE_OF_THE_DOOMED.info =  function(self, t)
...
Talents.talents_def.T_PITILESS.name = "无情"
Talents.talents_def.T_PITILESS.info = function(self, t)
