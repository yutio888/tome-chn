...
Talents.talents_def.T_FRENZIED_BITE.name= "狂乱撕咬"
Talents.talents_def.T_FRENZIED_BITE.info= function(self, t)
...
Talents.talents_def.T_FRENZIED_LEAP.name= "狂乱跳跃"
Talents.talents_def.T_FRENZIED_LEAP.info= function(self, t)
		return ([[跳 向 范 围 内 目 标。 只 有 在 狂 乱 状 态 下 可 以 使 用。]])
	end
Talents.talents_def.T_GNASHING_TEETH.name= "咬牙切齿"
Talents.talents_def.T_GNASHING_TEETH.info= function(self, t)
		local damage = t.getDamage(self, t) * 100
		local bleed = t.getBleedDamage(self, t) * 100
...
Talents.talents_def.T_ABYSSAL_SHROUD.name= "堕入深渊"
Talents.talents_def.T_ABYSSAL_SHROUD.info= function(self, t)
...
Talents.talents_def.T_ECHOES_FROM_THE_VOID.name= "虚空回音"
Talents.talents_def.T_ECHOES_FROM_THE_VOID.info= function(self, t)
		local damage = t.getDamage(self, t)
...
Talents.talents_def.T_VOID_SHARDS.name= "虚空碎片"
Talents.talents_def.T_VOID_SHARDS.info= function(self, t)
...
Talents.talents_def.T_WORM_ROT.name= "腐烂蠕虫"
Talents.talents_def.T_WORM_ROT.info= function(self, t)
		local duration = t.getDuration(self, t)
		local damage = t.getDamage(self, t)
...
Talents.talents_def.T_KNIFE_STORM.name= "刀刃风暴"
Talents.talents_def.T_KNIFE_STORM.info= function(self, t)
		local damage = t.getDamage(self, t)
		local duration = t.getDuration(self, t)
...
Talents.talents_def.T_PSIONIC_PULL.name= "念力牵引"
Talents.talents_def.T_PSIONIC_PULL.info= function(self, t)
...
Talents.talents_def.T_RAZOR_KNIFE.name= "刀锋之刃"
Talents.talents_def.T_RAZOR_KNIFE.info= function(self, t)
...
Talents.talents_def.T_SLIME_WAVE.name= "史莱姆冲击波"
Talents.talents_def.T_SLIME_WAVE.info= function(self, t)
		local damage = t.getDamage(self, t)
		local duration = t.getDuration(self, t)
...
Talents.talents_def.T_TENTACLE_GRAB.name= "触须之握"
Talents.talents_def.T_TENTACLE_GRAB.info= function(self, t)
		local damage = t.getDamage(self, t)
		local duration = t.getDuration(self, t)
...
Talents.talents_def.T_OOZE_SPIT.name= "凝胶喷射"
Talents.talents_def.T_OOZE_SPIT.info= function(self, t)
...
Talents.talents_def.T_OOZE_ROOTS.name= "史莱姆迁移"
Talents.talents_def.T_OOZE_ROOTS.info= function(self, t)
		local range = self:getTalentRange(t)
		local radius = self:getTalentRadius(t)
		return ([[变 成 史 莱 姆 遁 入 地 下， 并 在 %d 至 %d 范 围 内 重 新 出 现。]]):format(range, radius)
	end
Talents.talents_def.T_ANIMATE_BLADE.name= "虚空利刃"
Talents.talents_def.T_ANIMATE_BLADE.info= function(self, t)
