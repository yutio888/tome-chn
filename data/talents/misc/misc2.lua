...
Talents.talents_def.T_ATTACK.name= "攻击"
Talents.talents_def.T_ATTACK.info= function(self, t)
...
Talents.talents_def.T_SHERTUL_FORTRESS_GETOUT.name= "返回地面"
Talents.talents_def.T_SHERTUL_FORTRESS_GETOUT.info= [[使 用 堡 垒 自 带 的 传 送 系 统 “ 哔 ” 的 一 下 回 到 地 面。
	Requires being in flight above the ground of a planet.]]

Talents.talents_def.T_SHERTUL_FORTRESS_BEAM.name= "火力支援"
Talents.talents_def.T_SHERTUL_FORTRESS_BEAM.info= [[消 耗 10 点 堡 垒 能 量， 将 一 股 强 大 的 爆 炸 能 量 送 到 地 面， 重 创 任 何 区 域 内 的 敌 人。
	Requires being in flight above the ground of a planet.]]
