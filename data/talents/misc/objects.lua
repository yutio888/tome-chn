...
Talents.talents_def.T_ARCANE_SUPREMACY.name= "奥术至尊"
Talents.talents_def.T_ARCANE_SUPREMACY.info= function(self, t)
...
Talents.talents_def.T_COMMAND_STAFF.name= "法杖掌控"
Talents.talents_def.T_COMMAND_STAFF.info= function(self, t)
		return ([[改 变 法 杖 中 流 动 的 能 量 性 质。]])
	end
Talents.talents_def.T_WARD.name= "守护"
Talents.talents_def.T_WARD.info= function(self, t)
		local xs = ""
...
Talents.talents_def.T_BLOCK.name= "格挡"
Talents.talents_def.T_BLOCK.info= function(self, t)
...
Talents.talents_def.T_BLOOM_HEAL.name= "夏花之愈"
Talents.talents_def.T_BLOOM_HEAL.info= function(self, t)
...
Talents.talents_def.T_DIG_OBJECT.name= "挖掘"
Talents.talents_def.T_DIG_OBJECT.info = function(self, t)
		local best = t.findBest(self, t) or {digspeed=100}
		return ([[ 挖 掘 消 耗 %d 回 合 ( 基 于 你 携 带 的 最 好 锄 头 )。 ]])
		:format(best.digspeed)
	end
Talents.talents_def.T_SHIV_LORD.name= "寒冰元素"
Talents.talents_def.T_SHIV_LORD.info= function(self, t)
...
Talents.talents_def.T_MENTAL_REFRESH.name= "振作精神"
Talents.talents_def.T_MENTAL_REFRESH.info= function(self, t)
		return ([[ 刷 新 至 多 3 个 自 然 ， 超 能 或 诅 咒 系 技 能 。 ]])
	end
Talents.talents_def.T_DAGGER_BLOCK.name= "匕首格挡"
Talents.talents_def.T_DAGGER_BLOCK.info= function(self, t)
...
Talents.talents_def.T_SHIELDSMAIDEN_AURA.name= "女武神之守护"
Talents.talents_def.T_SHIELDSMAIDEN_AURA.info= function(self, t)
		return ([[每 10 回 合 能 自 动 抵 抗 一 次 攻 击 .]])
	end

Talents.talents_def.T_PSIONIC_MAELSTROM.name= "灵能风暴"
Talents.talents_def.T_PSIONIC_MAELSTROM.info= function(self, t)
