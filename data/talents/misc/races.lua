...
Talents.talents_def.T_HIGHER_HEAL.name= "高贵血统"
Talents.talents_def.T_HIGHER_HEAL.info= function(self, t)
		return ([[召 唤 高 贵 血 统 来 使 你 的 身 体 以 %d 点 每 回 合 的 速 率 恢 复， 持 续 10 回 合。 
		 受 意 志 影 响， 生 命 恢 复 量 有 额 外 增 益。]]):format(5 + self:getWil() * 0.5)
	end
Talents.talents_def.T_OVERSEER_OF_NATIONS.name= "远见卓识"
Talents.talents_def.T_OVERSEER_OF_NATIONS.info= function(self, t)
...
Talents.talents_def.T_BORN_INTO_MAGIC.name= "魔法亲和"
Talents.talents_def.T_BORN_INTO_MAGIC.info= function(self, t)
...
Talents.talents_def.T_HIGHBORN_S_BLOOM.name= "生命绽放"
Talents.talents_def.T_HIGHBORN_S_BLOOM.info= function(self, t)
...
Talents.talents_def.T_SHALOREN_SPEED.name= "不朽的恩赐"
Talents.talents_def.T_SHALOREN_SPEED.info= function(self, t)
...
Talents.talents_def.T_MAGIC_OF_THE_ETERNALS.name= "不朽的魔法"
Talents.talents_def.T_MAGIC_OF_THE_ETERNALS.info= function(self, t)
		return ([[因 为 永 恒 精 灵 的 自 然 魔 法， 现 实 发 生 了 轻 微 的 扭 曲。 
		 提 高 %d%% 的 暴 击 概 率 和 %d%% 暴 击 伤 害。]]):
		format(t.critChance(self, t), t.critPower(self, t))
	end
Talents.talents_def.T_SECRETS_OF_THE_ETERNALS.name= "不朽的秘密"
Talents.talents_def.T_SECRETS_OF_THE_ETERNALS.info= function(self, t)
...
Talents.talents_def.T_TIMELESS.name= "超越永恒"
Talents.talents_def.T_TIMELESS.info= function(self, t)
...
Talents.talents_def.T_THALOREN_WRATH.name= "森林之怒"
Talents.talents_def.T_THALOREN_WRATH.info= function(self, t)
...
Talents.talents_def.T_UNSHACKLED.name= "潜能爆发"
Talents.talents_def.T_UNSHACKLED.info= function(self, t)
		return ([[自 然 精 灵 一 度 自 由 的 生 活 在 他 们 热 爱 的 森 林， 从 不 关 心 外 界 的 事 物。 
		 提 高 物 理 和 精 神 豁 免 +%d 点。]]):
		format(t.getSave(self, t))
	end
Talents.talents_def.T_GUARDIAN_OF_THE_WOOD.name= "森林守护"
Talents.talents_def.T_GUARDIAN_OF_THE_WOOD.info= function(self, t)
...
Talents.talents_def.T_NATURE_S_PRIDE.name= "自然的骄傲"
Talents.talents_def.T_NATURE_S_PRIDE.info= function(self, t)
...
Talents.talents_def.T_DWARF_RESILIENCE.name= "钢筋铁骨"
Talents.talents_def.T_DWARF_RESILIENCE.info= function(self, t)
...
Talents.talents_def.T_STONESKIN.name= "石化皮肤"
Talents.talents_def.T_STONESKIN.info= function(self, t)
...
Talents.talents_def.T_POWER_IS_MONEY.name= "金钱就是力量"
Talents.talents_def.T_POWER_IS_MONEY.info= function(self, t)
...
Talents.talents_def.T_STONE_WALKING.name= "穿墙术"
Talents.talents_def.T_STONE_WALKING.info= function(self, t)
...
Talents.talents_def.T_HALFLING_LUCK.name= "小不点的幸运"
Talents.talents_def.T_HALFLING_LUCK.info= function(self, t)
		local params = t.getParams(self, t)
...
Talents.talents_def.T_DUCK_AND_DODGE.name= "闪避"
Talents.talents_def.T_DUCK_AND_DODGE.info= function(self, t)
...
Talents.talents_def.T_MILITANT_MIND.name= "英勇"
Talents.talents_def.T_MILITANT_MIND.info= function(self, t)
...
Talents.talents_def.T_INDOMITABLE.name= "不屈意志"
Talents.talents_def.T_INDOMITABLE.info= function(self, t)
		local duration = t.getDuration(self, t)
...
Talents.talents_def.T_ORC_FURY.name= "兽族之怒"
Talents.talents_def.T_ORC_FURY.info= function(self, t)
		return ([[激 活 你 对 杀 戮 和 破 坏 的 渴 望， 增 加 %d%% 所 有 伤 害， 持 续 5 回 合。 
		 受 意 志 影 响， 增 益 有 额 外 加 成。]]):
		format(t.getPower(self, t))
	end
Talents.talents_def.T_HOLD_THE_GROUND.name= "兽族之怒"
Talents.talents_def.T_HOLD_THE_GROUND.info= function(self, t)
		return ([[其 他 种 族 对 兽 族 的 猎 杀 持 续 了 上 千 年， 不 管 是 否 正 义。 他 们 已 经 学 会 忍 受 那 些 会 摧 毁 弱 小 种 族 的 灾 难。 
		 增 加 +%d 物 理 和 精 神 豁 免。]]):
		format(t.getSaves(self, t))
	end
Talents.talents_def.T_SKIRMISHER.name= "杀戮者"
Talents.talents_def.T_SKIRMISHER.info= function(self, t)
		return ([[兽 人 们 经 历 了 许 多 次 战 争， 并 获 胜 了 许 多 次。 
		 增 加 %d%% 所 有 伤 害 穿 透。]]):
		format(t.getPen(self, t))
	end
Talents.talents_def.T_PRIDE_OF_THE_ORCS.name= "兽族荣耀"
Talents.talents_def.T_PRIDE_OF_THE_ORCS.info= function(self, t)
...
Talents.talents_def.T_YEEK_WILL.name= "主导意志"
Talents.talents_def.T_YEEK_WILL.info= function(self, t)
...
Talents.talents_def.T_UNITY.name= "强化思维"
Talents.talents_def.T_UNITY.info= function(self, t)
...
Talents.talents_def.T_QUICKENED.name= "迅捷"
Talents.talents_def.T_QUICKENED.info= function(self, t)
		return ([[基 于 “ 精 神 网 络 ”， 夺 心 魔 新 陈 代 谢 很 快， 思 维 很 快 并 且 献 祭 也 很 快。 
		 增 加 %0.1f%% 整 体 速 度。]]):format(100*t.speedup(self, t))
	end
Talents.talents_def.T_WAYIST.name= "快速支援"
Talents.talents_def.T_WAYIST.info= function(self, t)
		return ([[通 过 夺 心 魔 的 精 神 网 络， 迅 速 召 集 帮 手。 
		 在 你 周 围 召 唤 3 个 夺 心 魔 精 英 ，持 续 6 回 合。]])
	end
Talents.talents_def.T_YEEK_ID.name= "维网的力量"
Talents.talents_def.T_YEEK_ID.info= function(self, t)
...
Talents.talents_def.T_GRISLY_CONSTITUTION.name = "强大体魄"
Talents.talents_def.T_GRISLY_CONSTITUTION.info= function(self, t)
...
Talents.talents_def.T_WRIT_LARGE.name = "符文亲和"
Talents.talents_def.T_WRIT_LARGE.info= function(self, t)
