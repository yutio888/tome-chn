...
Talents.talents_def.T_DISTORTION_WAVE.name= "扭曲之涛"
Talents.talents_def.T_DISTORTION_WAVE.info= function(self, t)
		local damage = t.getDamage(self, t)
		local radius = self:getTalentRadius(t)
...
Talents.talents_def.T_RAVAGE.name= "疯狂扭曲"
Talents.talents_def.T_RAVAGE.info= function(self, t)
		local damage = t.getDamage(self, t)
...
Talents.talents_def.T_MAELSTROM.name= "灵能漩涡"
Talents.talents_def.T_MAELSTROM.info= function(self, t)
		local duration = t.getDuration(self, t)
		local damage = t.getDamage(self, t)
		local radius = self:getTalentRadius(t)
		local distort = DistortionCount(self)
