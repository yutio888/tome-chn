...
Talents.talents_def.T_MINDLASH.name= "心灵鞭笞"
Talents.talents_def.T_MINDLASH.info= function(self, t)
...
Talents.talents_def.T_PYROKINESIS.name= "意念燃烧"
Talents.talents_def.T_PYROKINESIS.info= function(self, t)
...
Talents.talents_def.T_BRAIN_STORM.name= "头脑风暴"
Talents.talents_def.T_BRAIN_STORM.info= function(self, t)
		local dam = t.getDamage(self, t)
...
Talents.talents_def.T_IRON_WILL.name= "钢铁意志"
Talents.talents_def.T_IRON_WILL.info= function(self, t)
