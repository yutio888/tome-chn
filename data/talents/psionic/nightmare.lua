...
Talents.talents_def.T_NIGHTMARE.name= "梦靥"
Talents.talents_def.T_NIGHTMARE.info= function(self, t)
...
Talents.talents_def.T_INNER_DEMONS.name= "心魔"
Talents.talents_def.T_INNER_DEMONS.info= function(self, t)
		local duration = t.getDuration(self, t)
...
Talents.talents_def.T_WAKING_NIGHTMARE.name= "梦靥复苏"
Talents.talents_def.T_WAKING_NIGHTMARE.info= function(self, t)
		local damage = t.getDamage(self, t)
		local duration = t.getDuration(self, t)
		local chance = t.getChance(self, t)
...
Talents.talents_def.T_NIGHT_TERROR.name= "梦靥降临"
Talents.talents_def.T_NIGHT_TERROR.info= function(self, t)
