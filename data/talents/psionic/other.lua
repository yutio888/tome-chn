...
Talents.talents_def.T_TELEKINETIC_GRASP.name= "念力之握"
Talents.talents_def.T_TELEKINETIC_GRASP.info= function(self, t)
		return ([[用 精 神 超 能 力 值 灌 注 一 件 武 器 或 宝 石， 使 它 能 够 承 受 你 的 精 神 力 量。]])
	end
Talents.talents_def.T_BEYOND_THE_FLESH.name= "超越肉体"
Talents.talents_def.T_BEYOND_THE_FLESH.info= function(self, t)
