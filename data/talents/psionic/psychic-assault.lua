...
Talents.talents_def.T_MIND_SEAR.name= "心灵光束"
Talents.talents_def.T_MIND_SEAR.info= function(self, t)
...
Talents.talents_def.T_PSYCHIC_LOBOTOMY.name= "精神切断"
Talents.talents_def.T_PSYCHIC_LOBOTOMY.info= function(self, t)
		local damage = t.getDamage(self, t)
...
Talents.talents_def.T_SYNAPTIC_STATIC.name= "心灵爆破"
Talents.talents_def.T_SYNAPTIC_STATIC.info= function(self, t)
		local damage = t.getDamage(self, t)
...
Talents.talents_def.T_SUNDER_MIND.name= "碾碎心灵"
Talents.talents_def.T_SUNDER_MIND.info= function(self, t)
		local damage = t.getDamage(self, t)
