...
Talents.talents_def.T_TRANSCENDENT_PYROKINESIS.name= "卓越热能"
Talents.talents_def.T_TRANSCENDENT_PYROKINESIS.info=function(self, t)
...
Talents.talents_def.T_BRAINFREEZE.name= "锁脑极寒"
Talents.talents_def.T_BRAINFREEZE.info= function(self, t)
...
Talents.talents_def.T_HEAT_SHIFT.name= "热能转移"
Talents.talents_def.T_HEAT_SHIFT.info= function(self, t)
...
Talents.talents_def.T_THERMAL_BALANCE.name= "热能平衡"
Talents.talents_def.T_THERMAL_BALANCE.info= function(self, t)
		local dam = t.getDamage(self, t)
