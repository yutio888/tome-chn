...
Talents.talents_def.T_TF_BOWMAN.name= "具象之弧：弓箭手"
Talents.talents_def.T_TF_BOWMAN.info= function(self, t)
...
Talents.talents_def.T_TF_WARRIOR.name= "具象之弧：狂战士"
Talents.talents_def.T_TF_WARRIOR.info= function(self, t)
		local stat = t.getStatBonus(self, t)
...
Talents.talents_def.T_TF_DEFENDER.name= "具象之弧：盾战士"
Talents.talents_def.T_TF_DEFENDER.info=function(self, t)
		local stat = t.getStatBonus(self, t)
...
Talents.talents_def.T_THOUGHT_FORMS.name= "具象之弧"
Talents.talents_def.T_THOUGHT_FORMS.info= function(self, t)
...
Talents.talents_def.T_TRANSCENDENT_THOUGHT_FORMS.name= "具象之弧：卓越"
Talents.talents_def.T_TRANSCENDENT_THOUGHT_FORMS.info=function(self, t)
		local level = math.floor(self:getTalentLevel(t))
		return([[你 的 精 神 体 习 得 技 能 等 级 为 %d 的 清 晰 梦 境、 生 物 反 馈 和 共 鸣 之 心。]]):format(level)
	end
Talents.talents_def.T_OVER_MIND.name= "具象之弧：支配"
Talents.talents_def.T_OVER_MIND.info= function(self, t)
...
Talents.talents_def.T_TF_UNITY.name= "具象之弧：共鸣"
Talents.talents_def.T_TF_UNITY.info= function(self, t)
