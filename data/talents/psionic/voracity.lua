...
Talents.talents_def.T_KINETIC_LEECH.name= "动能吸取"
Talents.talents_def.T_KINETIC_LEECH.info= function(self, t)
...
Talents.talents_def.T_THERMAL_LEECH.name= "热能吸取"
Talents.talents_def.T_THERMAL_LEECH.info= function(self, t)
		local range = self:getTalentRadius(t)
...
Talents.talents_def.T_CHARGE_LEECH.name= "电能吸取"
Talents.talents_def.T_CHARGE_LEECH.info= function(self, t) 
		local range = self:getTalentRadius(t)
...
Talents.talents_def.T_INSATIABLE.name= "贪得无厌"
Talents.talents_def.T_INSATIABLE.info= function(self, t)
