...
Talents.talents_def.T_ACID_INFUSION.name= "酸液充能"
Talents.talents_def.T_ACID_INFUSION.info= function(self, t)
		local daminc = t.getIncrease(self, t)
		return ([[ 将 酸 性 能 量 填 充 至 炼 金 炸 弹 ， 能 致 盲 敌 人 。
		 你 造 成 的 酸 性 伤 害 增 加 %d%% 。]]):
		format(daminc)
	end
Talents.talents_def.T_CAUSTIC_GOLEM.name= "酸液覆体"
Talents.talents_def.T_CAUSTIC_GOLEM.info= function(self, t)
...
Talents.talents_def.T_CAUSTIC_MIRE.name= "腐蚀之地"
Talents.talents_def.T_CAUSTIC_MIRE.info= function(self, t)
...
Talents.talents_def.T_DISSOLVING_ACID.name= "酸液溶解"
Talents.talents_def.T_DISSOLVING_ACID.info= function(self, t)
		local damage = t.getDamage(self, t)
