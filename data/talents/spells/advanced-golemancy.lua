...
Talents.talents_def.T_GOLEMANCY_LIFE_TAP.name= "生命分流"
Talents.talents_def.T_GOLEMANCY_LIFE_TAP.info= function(self, t)
		local power=t.getPower(self, t)
		return ([[你 汲 取 傀 儡 的 生 命 能 量 来 恢 复 自 己。 恢 复 %d 点 生 命。]]):
		format(power)
	end
Talents.talents_def.T_GEM_GOLEM.name= "宝石傀儡"
Talents.talents_def.T_GEM_GOLEM.info= function(self, t)
...
Talents.talents_def.T_SUPERCHARGE_GOLEM.name= "超能傀儡"
Talents.talents_def.T_SUPERCHARGE_GOLEM.info= function(self, t)
