...
Talents.talents_def.T_HEAL.name= "奥术重组"
Talents.talents_def.T_HEAL.info= function(self, t)
		local heal = t.getHeal(self, t)
		return ([[使 你 的 身 体 充 满 奥 术 能 量， 将 其 重 组 为 原 始 状 态， 治 疗 %d 点 生 命 值。 
		 受 法 术 强 度 影 响， 治 疗 量 有 额 外 加 成。]]):
		format(heal)
	end
Talents.talents_def.T_SHIELDING.name= "强化护盾"
Talents.talents_def.T_SHIELDING.info= function(self, t)
...
Talents.talents_def.T_ARCANE_SHIELD.name= "奥术护盾"
Talents.talents_def.T_ARCANE_SHIELD.info= function(self, t)
		local shield = t.getShield(self, t)
...
Talents.talents_def.T_AEGIS.name= "守护印记"
Talents.talents_def.T_AEGIS.info= function(self, t)
		local shield = t.getShield(self, t)
