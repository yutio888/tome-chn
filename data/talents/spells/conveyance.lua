...
Talents.talents_def.T_PHASE_DOOR.name= "次元之门"
Talents.talents_def.T_PHASE_DOOR.info= function(self, t)
...
Talents.talents_def.T_TELEPORT.name= "传送"
...
Talents.talents_def.T_DISPLACEMENT_SHIELD.name= "相位护盾"
Talents.talents_def.T_DISPLACEMENT_SHIELD.info= function(self, t)
...
Talents.talents_def.T_PROBABILITY_TRAVEL.name= "次元移动"
Talents.talents_def.T_PROBABILITY_TRAVEL.info= function(self, t)
		local range = t.getRange(self, t)
