...
local DamageType = require "engine.DamageType"
Talents.talents_def.T_ARCANE_EYE.name= "奥术之眼"
Talents.talents_def.T_ARCANE_EYE.info= function(self, t)
...
Talents.talents_def.T_KEEN_SENSES.name= "敏锐直觉"
Talents.talents_def.T_KEEN_SENSES.info= function(self, t)
...
Talents.talents_def.T_VISION.name= "探测"
Talents.talents_def.T_VISION.info= function(self, t)
		local radius = t.getRadius(self, t)
		return ([[通 过 意 念 探 测 周 围 地 形， 有 效 范 围： %d  码。]]):
		format(radius)
	end
Talents.talents_def.T_PREMONITION.name= "预感"
Talents.talents_def.T_PREMONITION.info= function(self, t)
