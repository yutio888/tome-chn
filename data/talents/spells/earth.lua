...
Talents.talents_def.T_STONE_SKIN.name= "石化皮肤"
Talents.talents_def.T_STONE_SKIN.info= function(self, t)
		local armor = t.getArmor(self, t)
		return ([[施 法 者 的 皮 肤 变 的 和 岩 石 一 样 坚 硬， 提 高 %d 点 护 甲。 
		 受 法 术 强 度 影 响， 护 甲 有 额 外 加 成。]]):
		format(armor)
	end
Talents.talents_def.T_DIG.name= "粉碎钻击"
Talents.talents_def.T_DIG.info= function(self, t)
...
Talents.talents_def.T_MUDSLIDE.name= "山崩地裂"
Talents.talents_def.T_MUDSLIDE.info= function(self, t)
		local damage = t.getDamage(self, t)
...
Talents.talents_def.T_STONE_WALL.name= "岩石堡垒"
Talents.talents_def.T_STONE_WALL.info= function(self, t)
