...
Talents.talents_def.T_ELDRITCH_SLAM.name = "奥术猛击"

Talents.talents_def.T_ELDRITCH_BLOW.info = function(self, t)
...
Talents.talents_def.T_ELDRITCH_SLAM.info = function(self, t)
