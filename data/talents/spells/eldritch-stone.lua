...
Talents.talents_def.T_IMPALING_SPIKES.name = "穿透尖刺"

Talents.talents_def.T_STONE_SPIKES.info = function(self, t)
		local xs = ""
...
Talents.talents_def.T_POISONED_SPIKES.info =  function(self, t)
...
Talents.talents_def.T_ELDRITCH_SPIKES.info = function(self, t)
		local dam = t.getDamage(self, t)
		return ([[用 奥 术 能 量 填 充 岩 石 尖 刺 ， 造 成  %0.1f 奥 术 伤 害 ，并 沉 默 %d 回 合 。]]):
		format( t.getDamage(self, t), t.getSilence(self, t))
	end
Talents.talents_def.T_IMPALING_SPIKES.info = function(self, t)
