...
Talents.talents_def.T_THROW_BOMB.name= "炸弹投掷"
Talents.talents_def.T_THROW_BOMB.info= function(self, t)
...
Talents.talents_def.T_ALCHEMIST_PROTECTION.name= "炼金保护"
Talents.talents_def.T_ALCHEMIST_PROTECTION.info= function(self, t)
...
Talents.talents_def.T_EXPLOSION_EXPERT.name= "爆破专家"
...
Talents.talents_def.T_SHOCKWAVE_BOMB.info= function(self, t)
		local ammo = self:hasAlchemistWeapon()
		local dam, damtype = 1
