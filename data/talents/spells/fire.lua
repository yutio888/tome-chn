...
Talents.talents_def.T_FLAME.name= "火球术"
Talents.talents_def.T_FLAME.info= function(self, t)
...
Talents.talents_def.T_FLAMESHOCK.name= "火焰冲击"
Talents.talents_def.T_FLAMESHOCK.info= function(self, t)
		local damage = t.getDamage(self, t)
...
Talents.talents_def.T_FIREFLASH.name= "爆裂火球"
Talents.talents_def.T_FIREFLASH.info= function(self, t)
		local damage = t.getDamage(self, t)
		local radius = self:getTalentRadius(t)
...
Talents.talents_def.T_INFERNO.name= "地狱火"
Talents.talents_def.T_INFERNO.info= function(self, t)
		local damage = t.getDamage(self, t)
