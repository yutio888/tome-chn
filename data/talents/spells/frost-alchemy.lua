...
Talents.talents_def.T_FROST_INFUSION.name= "冰霜充能"
Talents.talents_def.T_FROST_INFUSION.info= function(self, t)
		local daminc = t.getIncrease(self, t)
		return ([[将 寒 冰 能 量 填 充 至 炼 金 炸 弹 ， 能 冰 冻 敌 人 。
		 你 造 成 的 寒 冰 伤 害 增 加 %d%% 。]]):
		format(daminc)
	end
Talents.talents_def.T_ICE_ARMOUR.name= "寒冰护甲"
Talents.talents_def.T_ICE_ARMOUR.info= function(self, t)
...
Talents.talents_def.T_FLASH_FREEZE.name= "极速冻结"
Talents.talents_def.T_FLASH_FREEZE.info= function(self, t)
...
Talents.talents_def.T_BODY_OF_ICE.name= "冰霜之躯"
