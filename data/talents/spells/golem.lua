...
Talents.talents_def.T_GOLEM_KNOCKBACK.name= "击退"
Talents.talents_def.T_GOLEM_KNOCKBACK.info= function(self, t)
		local damage = t.getDamage(self, t)
		return ([[你 的 傀 儡 冲 向 目 标， 将 其 击 退 并 造 成 %d%% 伤 害。 
		 受 技 能 等 级 影 响， 击 退 几 率 有 额 外 加 成。]]):format(100 * damage)
	end
Talents.talents_def.T_GOLEM_TAUNT.name= "嘲讽"
Talents.talents_def.T_GOLEM_TAUNT.info= function(self, t)
		return ([[你 的 傀 儡 嘲 讽 %d 码 半 径 范 围 的 敌 人， 强 制 他 们 攻 击 傀 儡。]]):format(self:getTalentRadius(t)) 
	end
Talents.talents_def.T_GOLEM_CRUSH.name= "压碎"
Talents.talents_def.T_GOLEM_CRUSH.info= function(self, t)
		local damage = t.getDamage(self, t)
...
Talents.talents_def.T_GOLEM_POUND.name= "敲击"
Talents.talents_def.T_GOLEM_POUND.info= function(self, t)
...
Talents.talents_def.T_GOLEM_BEAM.name= "眼睛光束"
Talents.talents_def.T_GOLEM_BEAM.info= function(self, t)
		local damage = t.getDamage(self, t)
...
Talents.talents_def.T_GOLEM_REFLECTIVE_SKIN.name= "反射皮肤"
Talents.talents_def.T_GOLEM_REFLECTIVE_SKIN.info= function(self, t)
...
Talents.talents_def.T_GOLEM_ARCANE_PULL.name= "奥术牵引"
Talents.talents_def.T_GOLEM_ARCANE_PULL.info= function(self, t)
		local rad = self:getTalentRadius(t)
		local dam = t.getDamage(self, t)
		return ([[你 的 傀 儡 将 %d 码 范 围 内 的 敌 人 牵 引 至 身 边， 并 造 成 %0.2f 奥 术 伤 害。]]):
		format(rad, dam)
	end
Talents.talents_def.T_GOLEM_MOLTEN_SKIN.name= "熔岩皮肤"
Talents.talents_def.T_GOLEM_MOLTEN_SKIN.info= function(self, t)
...
Talents.talents_def.T_GOLEM_DESTRUCT.name= "自爆"
Talents.talents_def.T_GOLEM_DESTRUCT.info= function(self, t)
		local rad = self:getTalentRadius(t)
...
Talents.talents_def.T_GOLEM_ARMOUR.name= "护甲掌握"
Talents.talents_def.T_GOLEM_ARMOUR.info= function(self, t)
...
Talents.talents_def.T_DROLEM_POISON_BREATH.info= function(self, t)
