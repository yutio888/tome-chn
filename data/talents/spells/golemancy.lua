...
Talents.talents_def.T_INTERACT_GOLEM.name= "检查傀儡"
Talents.talents_def.T_INTERACT_GOLEM.infoo= function(self, t)
		return ([[和 你 的 傀 儡 交 互， 检 查 它 的 物 品、 技 能 等。]]):
		format()
	end
Talents.talents_def.T_REFIT_GOLEM.name= "改装傀儡"
Talents.talents_def.T_REFIT_GOLEM.info= function(self, t)
...
Talents.talents_def.T_GOLEM_RESILIENCE.name= "坚韧傀儡"
Talents.talents_def.T_GOLEM_RESILIENCE.info= function(self, t)
...
Talents.talents_def.T_INVOKE_GOLEM.name= "傀儡召返"
Talents.talents_def.T_INVOKE_GOLEM.info= function(self, t)
		local power=t.getPower(self, t)
		return ([[你 将 傀 儡 拉 到 你 身 边， 使 它 暂 时 性 增 加 %d 点 近 战 物 理 强 度， 持 续 5 回 合。]]):
		format(power)
	end
Talents.talents_def.T_GOLEM_PORTAL.name= "傀儡传送"
Talents.talents_def.T_GOLEM_PORTAL.info= function(self, t)
