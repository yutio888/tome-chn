...
Talents.talents_def.T_CHILL_OF_THE_TOMB.name= "极寒坟墓"
Talents.talents_def.T_CHILL_OF_THE_TOMB.info= function(self, t)
...
Talents.talents_def.T_WILL_O__THE_WISP.name= "鬼火"
Talents.talents_def.T_WILL_O__THE_WISP.info= function(self, t)
...
Talents.talents_def.T_COLD_FLAMES.name= "骨灵冷火"
Talents.talents_def.T_COLD_FLAMES.info= function(self, t)
		local radius = self:getTalentRadius(t)
		local damage = t.getDamage(self, t)
...
Talents.talents_def.T_VAMPIRIC_GIFT.name= "血族礼物"
Talents.talents_def.T_VAMPIRIC_GIFT.info= function(self, t)
