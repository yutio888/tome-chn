...
Talents.talents_def.T_DISPERSE_MAGIC.name= "驱散"
Talents.talents_def.T_DISPERSE_MAGIC.info= function(self, t)
		local count = t.getRemoveCount(self, t)
		return ([[驱 散 目 标 身 上 的 %d 种 魔 法 效 果（ 敌 方 单 位 的 增 益 状 态 和 友 方 单 位 的 负 面 状 态）。 
		 在 等 级 3 时 可 以 选 择 目 标。]]):
		format(count)
	end
Talents.talents_def.T_SPELLCRAFT.name= "法术亲和"
Talents.talents_def.T_SPELLCRAFT.info= function(self, t)
...
Talents.talents_def.T_QUICKEN_SPELLS.name= "快速施法"
Talents.talents_def.T_QUICKEN_SPELLS.info= function(self, t)
		local cooldownred = t.getCooldownReduction(self, t)
		return ([[减 少 %d%% 所 有 法 术 冷 却 时 间。]]):
		format(cooldownred * 100)
	end
Talents.talents_def.T_METAFLOW.name= "奥术流动"
Talents.talents_def.T_METAFLOW.info= function(self, t)
