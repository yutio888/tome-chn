...
Talents.talents_def.T_BLURRED_MORTALITY.name= "模糊死亡"
Talents.talents_def.T_BLURRED_MORTALITY.info= function(self, t)
		return ([[对 你 而 言， 生 死 之 别 变 的 模 糊， 你 只 有 在 生 命 值 下 降 到 -%d 时 才 会 死 亡。 ]]):
		format(t.lifeBonus(self, t))
	end
Talents.talents_def.T_IMPENDING_DOOM.name= "灾厄降临"
Talents.talents_def.T_IMPENDING_DOOM.info=function(self, t)
...
Talents.talents_def.T_UNDEATH_LINK.name= "亡灵分流"
Talents.talents_def.T_UNDEATH_LINK.info= function(self, t)
		local heal = t.getHeal(self, t)
		return ([[[吸 收 你 所 有 亡 灵 随 从 %d%% 的 最 大 生 命 值（ 可 能 会 杀 死 它 们） 并 使 用 这 股 能 量 治 愈 你。
		 受 法 术 强 度 影 响， 治 疗 量 有 额 外 加 成。]]):
		format(heal)
	end
Talents.talents_def.T_LICHFORM.name= "巫妖转生"
Talents.talents_def.T_LICHFORM.info= function(self, t)
