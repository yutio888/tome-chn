...
Talents.talents_def.T_NECROTIC_AURA.name= "死灵光环"
Talents.talents_def.T_NECROTIC_AURA.info= function(self, t)
...
Talents.talents_def.T_CREATE_MINIONS.name= "亡灵召唤"
Talents.talents_def.T_CREATE_MINIONS.info= function(self, t)
...
Talents.talents_def.T_AURA_MASTERY.name= "光环掌握"
Talents.talents_def.T_AURA_MASTERY.info= function(self, t)
...
Talents.talents_def.T_SURGE_OF_UNDEATH.name= "不死狂潮"
Talents.talents_def.T_SURGE_OF_UNDEATH.info= function(self, t)
...
Talents.talents_def.T_DARK_EMPATHY.name= "黑暗共享"
Talents.talents_def.T_DARK_EMPATHY.info= function(self, t)
