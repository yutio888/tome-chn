...
Talents.talents_def.T_INVOKE_DARKNESS.name= "黑夜降临"
Talents.talents_def.T_INVOKE_DARKNESS.info= function(self, t)
...
Talents.talents_def.T_CIRCLE_OF_DEATH.name= "死亡之环"
Talents.talents_def.T_CIRCLE_OF_DEATH.info= function(self, t)
		local damage = t.getDamage(self, t)
...
Talents.talents_def.T_FEAR_THE_NIGHT.name= "暗夜恐惧"
Talents.talents_def.T_FEAR_THE_NIGHT.info= function(self, t)
		local damage = t.getDamage(self, t)
...
Talents.talents_def.T_RIGOR_MORTIS.name= "尸僵症"
Talents.talents_def.T_RIGOR_MORTIS.info= function(self, t)
		local damage = t.getDamage(self, t)
