...
Talents.talents_def.T_ILLUMINATE.name= "照明术"
Talents.talents_def.T_ILLUMINATE.info= function(self, t)
...
Talents.talents_def.T_BLUR_SIGHT.name= "模糊视觉"
Talents.talents_def.T_BLUR_SIGHT.info= function(self, t)
		local defence = t.getDefense(self, t)
		return ([[施 法 者 的 形 象 变 的 模 糊 不 清， 增 加 %d 点 闪 避。 
		 受 法 术 强 度 影 响， 闪 避 有 额 外 加 成。]]):
		format(defence)
	end
Talents.talents_def.T_PHANTASMAL_SHIELD.name= "幻象护盾"
Talents.talents_def.T_PHANTASMAL_SHIELD.info= function(self, t)
...
Talents.talents_def.T_INVISIBILITY.name= "隐形"
Talents.talents_def.T_INVISIBILITY.info= function(self, t)
