...
Talents.talents_def.T_SHADOW_TUNNEL.name= "暗影通道"
Talents.talents_def.T_SHADOW_TUNNEL.info= function(self, t)
...
Talents.talents_def.T_CURSE_OF_THE_MEEK.name= "驯服诅咒"
Talents.talents_def.T_CURSE_OF_THE_MEEK.info= function(self, t)
...
Talents.talents_def.T_FORGERY_OF_HAZE.name= "暗影分身"
Talents.talents_def.T_FORGERY_OF_HAZE.info= function(self, t)
...
Talents.talents_def.T_FROSTDUSK.name= "幽暗极冰"
Talents.talents_def.T_FROSTDUSK.info= function(self, t)
