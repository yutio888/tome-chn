...
Talents.talents_def.T_CHANNEL_STAFF.name= "魔法箭"
Talents.talents_def.T_CHANNEL_STAFF.info= function(self, t)
...
Talents.talents_def.T_STAFF_MASTERY.name= "法杖掌握"
Talents.talents_def.T_STAFF_MASTERY.info= function(self, t)
		local damage = t.getDamage(self, t)
		local inc = t.getPercentInc(self, t)
		return ([[增 加 %d 点 物 理 强 度。 同 时 法 杖 伤 害 增 加 %d%% 。]]):
		format(damage, 100 * inc)
	end
Talents.talents_def.T_DEFENSIVE_POSTURE.name= "闪避姿态"
Talents.talents_def.T_DEFENSIVE_POSTURE.info= function(self, t)
		local defense = t.getDefense(self, t)
		return ([[采 取 闪 避 姿 态， 增 加 你 %d 点 闪 避 和 护 甲 值。]]):
		format(defense)
	end
Talents.talents_def.T_BLUNT_THRUST.name= "钝器挥击"
Talents.talents_def.T_BLUNT_THRUST.info= function(self, t)
		local damage = t.getDamage(self, t)
