...
Talents.talents_def.T_CREATE_ALCHEMIST_GEMS.name= "制造炼金宝石"
Talents.talents_def.T_CREATE_ALCHEMIST_GEMS.info= function(self, t)
		return ([[从 自 然 宝 石 中 制 造 40 ～ 80 个 炼 金 宝 石。 
		 许 多 法 术 需 要 使 用 炼 金 宝 石。 
		 每 种 宝 石 拥 有 不 同 的 特 效。]]):format()
	end

Talents.talents_def.T_EXTRACT_GEMS.name= "宝石提炼"
Talents.talents_def.T_EXTRACT_GEMS.info= function(self, t)
		local material = ""
...
Talents.talents_def.T_GEM_PORTAL.info= function(self, t)
...
Talents.talents_def.T_STONE_TOUCH.name= "石化之触"
Talents.talents_def.T_STONE_TOUCH.info= function(self, t)
