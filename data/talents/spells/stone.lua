...
Talents.talents_def.T_EARTHEN_MISSILES.name= "岩石飞弹"
Talents.talents_def.T_EARTHEN_MISSILES.info= function(self, t)
		local count = 2
...
Talents.talents_def.T_BODY_OF_STONE.name= "岩石身躯"
Talents.talents_def.T_BODY_OF_STONE.info= function(self, t)
...
Talents.talents_def.T_EARTHQUAKE.name= "地震"
Talents.talents_def.T_EARTHQUAKE.info= function(self, t)
		local damage = t.getDamage(self, t)
...
Talents.talents_def.T_CRYSTALLINE_FOCUS.name= "水晶力场"
Talents.talents_def.T_CRYSTALLINE_FOCUS.info= function(self, t)
