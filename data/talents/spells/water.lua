...
Talents.talents_def.T_GLACIAL_VAPOUR.name= "寒霜冰雾"
Talents.talents_def.T_GLACIAL_VAPOUR.info= function(self, t)
...
Talents.talents_def.T_FREEZE.name= "冻结"
Talents.talents_def.T_FREEZE.info= function(self, t)
		local damage = t.getDamage(self, t)
...
Talents.talents_def.T_TIDAL_WAVE.name= "潮汐"
Talents.talents_def.T_TIDAL_WAVE.info= function(self, t)
		local damage = t.getDamage(self, t)
		local duration = t.getDuration(self, t)
...
Talents.talents_def.T_SHIVGOROTH_FORM.name= "寒冰之体"
Talents.talents_def.T_SHIVGOROTH_FORM.info= function(self, t)
...
Talents.talents_def.T_ICE_STORM.name= "冰雪风暴"
Talents.talents_def.T_ICE_STORM.info= function(self, t)
		local damage = t.getDamage(self, t)
		local duration = t.getDuration(self, t)
