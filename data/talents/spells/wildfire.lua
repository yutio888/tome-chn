...
Talents.talents_def.T_BLASTWAVE.name= "火焰新星"
Talents.talents_def.T_BLASTWAVE.info= function(self, t)
...
Talents.talents_def.T_BURNING_WAKE.name= "无尽之炎"
Talents.talents_def.T_BURNING_WAKE.info= function(self, t)
		local damage = t.getDamage(self, t)
...
Talents.talents_def.T_CLEANSING_FLAMES.name= "净化之焰"
Talents.talents_def.T_CLEANSING_FLAMES.info= function(self, t)
...
Talents.talents_def.T_WILDFIRE.name= "野火燎原"
Talents.talents_def.T_WILDFIRE.info= function(self, t)
