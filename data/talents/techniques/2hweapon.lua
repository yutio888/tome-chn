...
Talents.talents_def.T_DEATH_DANCE.name= "死亡之舞"
Talents.talents_def.T_DEATH_DANCE.info= function(self, t)
		return ([[原 地 旋 转， 伸 展 你 的 武 器， 伤 害 你 周 围 所 有 的 目 标， 造 成 %d%% 武 器 伤 害。]]):format(100 * self:combatTalentWeaponDamage(t, 1.4, 2.1))
	end
Talents.talents_def.T_BERSERKER.name= "狂暴"
Talents.talents_def.T_BERSERKER.info= function(self, t)
...
Talents.talents_def.T_WARSHOUT.name= "战争怒吼"
Talents.talents_def.T_WARSHOUT.info= function(self, t)
...
Talents.talents_def.T_DEATH_BLOW.name= "致命打击"
Talents.talents_def.T_DEATH_BLOW.info= function(self, t)
...
Talents.talents_def.T_STUNNING_BLOW.name= "震慑打击"
Talents.talents_def.T_STUNNING_BLOW.info= function(self, t)
...
Talents.talents_def.T_SUNDER_ARMOUR.name= "破甲"
Talents.talents_def.T_SUNDER_ARMOUR.info= function(self, t)
...
Talents.talents_def.T_SUNDER_ARMS.name= "破刃"
Talents.talents_def.T_SUNDER_ARMS.info= function(self, t)
