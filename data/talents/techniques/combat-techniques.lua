...
Talents.talents_def.T_RUSH.name= "冲锋"
...
Talents.talents_def.T_PRECISE_STRIKES.name= "精准打击"
Talents.talents_def.T_PRECISE_STRIKES.info= function(self, t)
...
Talents.talents_def.T_PERFECT_STRIKE.name= "完美打击"
Talents.talents_def.T_PERFECT_STRIKE.info= function(self, t)
...
Talents.talents_def.T_BLINDING_SPEED.name= "急速"
Talents.talents_def.T_BLINDING_SPEED.info= function(self, t)
		return ([[通 过 严 格 的 训 练 你 已 经 学 会 在 短 时 间 内 爆 发 你 的 速 度， 提 高 你 %d%% 速 度 5 回 合。]]):format(100*t.getSpeed(self, t))
	end
Talents.talents_def.T_QUICK_RECOVERY.name= "快速恢复"
Talents.talents_def.T_QUICK_RECOVERY.info= function(self, t)
		return ([[你 专 注 于 战 斗， 使 得 你 可 以 更 快 的 回 复 体 力（ +%0.1f 体 力 / 回 合）。]]):format(t.getStamRecover(self, t))
	end
Talents.talents_def.T_FAST_METABOLISM.name= "快速代谢"
Talents.talents_def.T_FAST_METABOLISM.info= function(self, t)
		return ([[你 专 注 于 战 斗， 使 你 可 以 更 快 的 回 复 生 命 值（ +%0.1f 生 命 值 / 回 合）。]]):format(t.getRegen(self, t))
	end
Talents.talents_def.T_SPELL_SHIELD.name= "法术抵抗"
Talents.talents_def.T_SPELL_SHIELD.info= function(self, t)
		return ([[严 格 的 训 练 使 得 你 对 某 些 法 术 效 果 具 有 更 高 的 抗 性（ +%d 法 术 豁 免）。]]):format(self:getTalentLevel(t) * 9)
	end
Talents.talents_def.T_UNENDING_FRENZY.name= "无尽怒火"
Talents.talents_def.T_UNENDING_FRENZY.info= function(self, t)
