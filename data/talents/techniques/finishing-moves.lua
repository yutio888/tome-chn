...
Talents.talents_def.T_UPPERCUT.name= "上钩拳"
Talents.talents_def.T_UPPERCUT.info= function(self, t)
...
Talents.talents_def.T_CONCUSSIVE_PUNCH.name= "金刚碎"
Talents.talents_def.T_CONCUSSIVE_PUNCH.info= function(self, t)
		local damage = t.getDamage(self, t) * 100
...
Talents.talents_def.T_BUTTERFLY_KICK.name= "蝴蝶踢"
Talents.talents_def.T_BUTTERFLY_KICK.info= function(self, t)
...
Talents.talents_def.T_HAYMAKER.name= "收割之刃"
Talents.talents_def.T_HAYMAKER.info= function(self, t)
		local damage = t.getDamage(self, t) * 100
