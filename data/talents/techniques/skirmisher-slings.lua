...
Talents.talents_def.T_SKIRMISHER_SLING_SUPREMACY.name= "投石索精通"
Talents.talents_def.T_SKIRMISHER_SLING_SUPREMACY.info= function(self, t)
...
Talents.talents_def.T_SKIRMISHER_SWIFT_SHOT.name= "快速投射"
Talents.talents_def.T_SKIRMISHER_SWIFT_SHOT.info= function(self, t)
		return ([[发 射 一 枚 快 速 的 石 弹， 造 成 %d%% 伤 害， 攻 击 速 度 是 你 普 通 攻 击 的 两 倍。 移 动 将 会 降 低 技 能 冷 却 1 回 合。]])
			:format(t.getDamage(self, t) * 100)
	end
Talents.talents_def.T_SKIRMISHER_HURRICANE_SHOT.name= "飓风连射"
Talents.talents_def.T_SKIRMISHER_HURRICANE_SHOT.info= function(self, t)
...
Talents.talents_def.T_SKIRMISHER_BOMBARDMENT.name= "连环炮击"
Talents.talents_def.T_SKIRMISHER_BOMBARDMENT.info= function(self, t)
