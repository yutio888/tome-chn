...
Talents.talents_def.T_JUGGERNAUT.name= "战场主宰"
Talents.talents_def.T_JUGGERNAUT.info= function(self, t)
...
Talents.talents_def.T_ONSLAUGHT.name= "猛攻"
Talents.talents_def.T_ONSLAUGHT.info= function(self, t)
...
Talents.talents_def.T_BATTLE_CALL.name= "挑衅"
Talents.talents_def.T_BATTLE_CALL.info= function(self, t)
		return ([[挑 衅 你 周 围 %d 码 半 径 范 围 内 的 敌 人 进 入 战 斗， 使 它 们 立 刻 进 入 近 战 状 态。]]):format(t.radius(self,t))
	end
Talents.talents_def.T_SHATTERING_IMPACT.name= "震荡攻击"
Talents.talents_def.T_SHATTERING_IMPACT.info= function(self, t)
