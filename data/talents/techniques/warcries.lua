...
Talents.talents_def.T_SHATTERING_SHOUT.name= "狮子吼"
Talents.talents_def.T_SHATTERING_SHOUT.info= function(self, t)
...
Talents.talents_def.T_SECOND_WIND.name= "宁神之风"
Talents.talents_def.T_SECOND_WIND.info= function(self, t)
		return ([[做 一 次 深 呼 吸 并 恢 复 %d%% 体 力 值。]]):
		format(t.getRestore(self, t))
	end

Talents.talents_def.T_BATTLE_SHOUT.name= "战斗鼓舞"
Talents.talents_def.T_BATTLE_SHOUT.info= function(self, t)
...
Talents.talents_def.T_BATTLE_CRY.name= "战斗怒喝"
Talents.talents_def.T_BATTLE_CRY.info= function(self, t)
