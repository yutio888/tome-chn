...
Talents.talents_def.T_GHOUL.name= "食尸者"
Talents.talents_def.T_GHOUL.info= function(self, t)
...
Talents.talents_def.T_GHOULISH_LEAP.name= "定向跳跃"
Talents.talents_def.T_GHOULISH_LEAP.info= function(self, t)
		return ([[跳 向 你 的 目 标。]])
	end
Talents.talents_def.T_RETCH.name= "亡灵唾液"
Talents.talents_def.T_RETCH.info= function(self, t)
...
Talents.talents_def.T_GNAW.name= "侵蚀"
Talents.talents_def.T_GNAW.info= function(self, t)
