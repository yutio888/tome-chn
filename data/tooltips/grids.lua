...
gridCHN["A farportal is a way to travel incredible distances in the blink of an eye. They usually require an external item to use."] = " 传送门是可以在眨眼间将你传送出很远距离的工具。它们通常需要一件关键道具来激活。"
gridCHN["The rift leads somewhere .."] = " 此缝隙似乎引导向某处…… "
gridCHN["This portal seems to be connected with Maj'Eyal, you could probably use it to go back."] = " 这个传送门似乎与马基 · 埃亚尔相连，你也许能通过它回去。"
gridCHN["A hole small enough that only you can go through."] = " 一个只有你能通过的小洞。"
...
gridCHN["An invocation portal, perpetually summoning beings through it."] = " 一个仪式传送门，可以不断的从另一边召唤生物。"
gridCHN["This portal seems to connect to an other part of this level."] = " 这个传送门似乎连接了此区域的另一边。"
gridCHN["The infinite hunt."] = " 无尽狩猎。"
gridCHN["The laws of the Ziguratnh"] = " 伊格兰斯法规 "
...
gridCHN["\"AN EDICT TO ALL CITIZENS OF THE IRON THRONE. LONG MAY OUR EMPIRE ENDURE\""] = " “向钢铁王座所有公民发布的公告。我们的王国将退隐于世。” "
...
gridCHN["This portal seems to be connected with Last Hope, you could probably use it to go back."] = " 这道传送门似乎通向最后的希望，你也许能通过它回去。"
...
gridCHN["The rift leads to Maj'Eyal"] = " 通向马基埃亚尔的裂缝 "
gridCHN["Contains a snippet of ToME wisdom."] = " 包含了 ToME 智慧的残片 "
gridCHN["This portal will bring you back to the Tutorial Lobby."] = " 这道传送门将把你带回教程大厅。"
gridCHN["Causes the player's brain to jettison all recently-acquired knowledge."] = " 可以净化玩家的大脑，使玩家遗忘所有最近所学的技能。"
gridCHN["Teaches the player 'Shove'."] = " 可习得技能“推挤” "
gridCHN["Teaches the player 'Mana Gale'."] = " 可习得技能“法力风暴” "
gridCHN["Teaches the player 'Telekinetic Punt'."] = " 可习得技能“念力打击” "
gridCHN["Teaches the player 'Blink'."] = " 可习得技能“闪光术” "
gridCHN["Teaches the player 'Fear'."] = " 可习得技能“恐惧” "
gridCHN["Teaches the player 'Bleed'."] = " 可习得技能“流血” "
gridCHN["Teaches the player 'Confusion'."] = " 可习得技能“混乱” "
gridCHN["The rift leads to an other part of the morass."] = " 此缝隙似乎引导向沼泽的另一边。"
gridCHN["A quiet town at the crossroads of the north"] = " 一个位于北方十字要道的宁静村庄。"
gridCHN["Capital city of the Allied Kingdoms ruled by King Tolak"] = " 联合王国首都（托拉克统治） "
gridCHN["Secret place of magic, set apart from the world to protect it.\nLead by the Supreme Archmage Linaniil."] = " 魔法的隐藏圣地，隔绝于世。 \n（魔导师莱娜尼尔守护） "
gridCHN["Capital city of Thaloren lands, ruled by Nessilla Tantaelen"] = " 自然精灵首都（奈希拉 · 坦泰兰守护） "
gridCHN["Capital city of Shaloren lands, ruled by Aranion Gayaeil"] = " 永恒精灵首都（阿兰尼恩 · 葛艾尔守护） "
gridCHN["A massive hole in the Sunwall."] = " 在太阳之墙的巨大孔洞。"
gridCHN["Yeek Wayist main village"] = " 夺心魔的聚居点 "
gridCHN["Ziguranth main training ground"] = " 伊格兰斯的主要训练基地 "
gridCHN["Heart of the dwarven Empire"] = " 矮人王国的心脏 "  
