...
一个活着的 #{bold}#夏图尔#{normal}#!.*#WHITE#
	...
	answers = {
		...
		{"我... 名为 "..player.name..", 尽管我失去了原本的身体，我的精神仍属于吞噬者加库尔。加库尔教导我们挑战传奇，即使面前是绝望和死亡也绝不退缩。现在，我站在这里面对着你，毫无恐惧，毫不犹豫，因为加库尔之意志在我体内燃烧。以他之名，我一定会#{bold}#打败#{normal}# 你! ", cond=is_yeti, action=on_end},
