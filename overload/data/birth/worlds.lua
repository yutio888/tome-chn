...
newBirthDescriptor{
	...
	desc =
	{
		"马 基 埃 亚 尔 生 活 着 人 类、 半 身 人 、 精 灵 和 矮 人。",
		"世 界 已 经 保 持 了 超 过 一 百 年 的 和 平 ， 各 大 种 族 再 次 繁 荣 起 来 ",
		"你 是 一 位 冒 险 者， 出 发 去 寻 找 失 落 的 宝 藏 和 荣 耀。",
		"在 世 界 的 阴 影 之 下 究 竟 潜 伏 着 什 么 呢？ ",
	},
...
newBirthDescriptor{
	...
	desc =
	{
		...
		"在 无 尽 地 城 中 你 不 受 限 制， 你 可 以 突 破 50 级 的 等 级 上 限 并 继 续 获 得 属 性 和 技 能 点 数（ 以 一 个 较 低 的 比 例 获 得）。 ",
		"50 级 之 后 属 性 最 大 值 每 级 增 加 1 点 。 ",
		"50 级 之 后 每 10 级 ， 技 能 的 最 大 等 级 增 加 1 点。 ",
	},
