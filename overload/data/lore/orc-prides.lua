...
直到现在，我还兽血沸腾着！如果我们强大的狂战士祖先加库尔看到伟大兽族臣服于人类，他会怎么想？！许多次，我曾想带着我族的精英战士去直接结束这场闹剧，但是——然阴谋诡计令我作呕，我不得不用。一次小小的背叛，就可以令我万劫不复。说实话，拾骨者拉克·肖和他的不死军团已经觊觎我的位置很多年了。这个问题长久以来一直困扰着我！但至少有一件事我们知道了，整个破坏事件是由晨曦之门的太阳教走狗们造成的……]],
}
...
我已经对几位女性进行了实验。她们在实验的过程中始终处于昏迷——那样会更有利于实验。起初我把她们放置在拥有自然催化和奥术回复的领域里，同时对她们胃部注入高蛋白营养。在时间加速的领域里堕落的血液被灌输进她们的卵巢中加速循环。Prides训练营的每位领袖都为这个实验贡献了自己的种子。
...
newLore{
	...
	category = "orc prides",
	name = "Ukruk's log",
	lore = [[夏图尔废墟和命令中的描述完全相符。尽管调查已经开始，速度仍旧缓慢无比，似乎很久以前它就坠毁在地面，难以寻找也难以接近。目标物品似乎是一根法杖，我不理解，法杖有什么重要的，显然最好的武器是剑或者斧头，因为这是伟大的乌克鲁克用的。
...
我们追在那个混蛋后面，发现他和德斯镇的一个矮人与一个人类会和，然后前往东南方。跟着三个人比跟着一个人简单多了，但我们还是要小心隐藏，因为命令要求我们不得暴露，同时尽量禁烧战斗。我已经训练好了一小队弓箭手和战士，教授他们如何藏身于树林中。
