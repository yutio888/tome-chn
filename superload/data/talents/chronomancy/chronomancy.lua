...
registerTalentTranslation{
	...
	info = function(self, t)
		...
		如果你学会了深谋远虑，那么在你激活这个技能的时候，你可以获得额外的闪避和暴击减免率（数值等于深谋远虑的奖励）。]]):format(range, duration)
	end,
}
...
registerTalentTranslation{
	...
	info = function(self, t)
		...
		return ([[获得 %d 闪避  和 %d%% 暴击减免率。
		如果你激活了预知未来或者命运螺旋，那么这些技能也会拥有同样的加成，使你获得额外的闪避和暴击减免率。
		受魔法影响，增益效果有额外加成。]]):
...
registerTalentTranslation{
	...
	info = function(self, t)
		...
		return ([[选择一个只会影响你并且不需要选中目标的非固定冷却时间主动法术。当你受到伤害并使生命值降低到 %d%% 以下时，自动释放这个技能。
...
registerTalentTranslation{
	...
	info = function(self, t)
		...
		如果你学会了深谋远虑，当你使用命运螺旋时，将获得额外的闪避和暴击减免率（数值等于深谋远虑的奖励）。
