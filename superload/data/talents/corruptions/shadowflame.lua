...
registerTalentTranslation{
	...
	info = function(self, t)
		return ([[转 化 为 鬼 魂， 允 许 你 穿 墙 且 不需要呼吸， 持 续 %d 回 合。 
...
registerTalentTranslation{
	...
	info = function(self, t)
		return ([[召 唤 一 部 分 恐 惧 空 间 与 现 有 空 间 交 叉。 
		 ...
		 在 恐 惧 空 间 内， 永 恒 之 焰 会 燃 烧 你 和 目 标， 造 成 %0.2f 火 焰 伤 害， 对恶魔则会改为进行治疗。
		 当 技 能 中 断 时， 你 和 目 标（ 如 果 还 活 着），以及所有掉落物品 会 被 带 回 原 来 空 间。
		 这 个 强 大 的 法 术 最初每 回 合 消 耗 5 点 活 力，活力值消耗每 回 合 增 加 1 点， 当 活 力 值 归 零 时 技 能 终 止 。
