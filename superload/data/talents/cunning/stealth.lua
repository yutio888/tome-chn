...
registerTalentTranslation{
	...
	info = function(self, t)
		...
		除 非 特 别 说 明 ， 任 何 非 瞬 间 非 移 动 技 能 均 会 打 破 潜 行。

		即 使 不 知 道 你 位 置 的 敌 人 ， 仍 然 会 猜 测 你 可 能 在 的 位 置。
		在 潜 行 时 ， 敌 人 无 法 分 享 有 关 你 位 置 的 信 息 ，并 且 会 一 直 相 信 你 还 在 那 里。]]):
...
registerTalentTranslation{
	...
	info = function (self,t)
		...
		你 自 动 进 入 潜 行 模 式 ， 在 %d 回 合 内， 你 的 行 动 不 会 使 你 主 动 显 形。]]):
