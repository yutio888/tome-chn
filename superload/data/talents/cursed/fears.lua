...
registerTalentTranslation{
	...
	info = function(self, t)
		...
		return ([[将恐惧注入目标范围内%d半径内的敌人中，造成%0.2f精神和%0.2f暗影伤害，并随机造成4种可能的恐惧效果之一，持续%d回合。
...
registerTalentTranslation{
	...
	name = "精神专制",
	info = function(self, t)
		return ([[提高对被你恐惧的目标的精神专制。当一个敌人获得了一个新的恐惧效果，你有%d%%的几率增加这一效果即另一个随机的已有恐惧效果的持续时间%d回合，最多8回合。
		此外，每当你恐惧一个目标，你获得%d精神强度和物理强度，持续5回合，最多叠加%d层]]):format(t. getExtendChance(self, t), t.getExtendFear(self, t), t.getTyrantPower(self, t), t.getMaxStacks(self, t))
	end,
}
