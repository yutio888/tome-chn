...
registerTalentTranslation{
	...
	info = function(self, t)
		...
		同 时， 每 个 技 能 等 级 增 加 你 的 物 理 强 度 和 命 中 2 点 。
		每 点 火 龙 系 的 技 能 可 以 使 你 增 加 火 焰 抵 抗 1%% 。
...
registerTalentTranslation{
	...
	info = function(self, t)
		...
		每 点 火 龙 系 的 技 能 可 以 使 你 增 加 火 焰 抵 抗 1%% 。]]):format(self:getTalentRadius(t), damDesc(self, DamageType.FIRE, t.getDamage(self, t)))
	end,
}
