...
registerTalentTranslation{
	...
	info = function(self, t)
		...
		维 持 这 样 的 护 盾 代 价 非 常 昂 贵 ，开 启 的 第 一 回 合 会 消 耗 你 5%%的 超 能 力 值 ，之 后 每 维 持 一 回 合 就 会 多 消 耗 5%%的 超 能 力 值 。例 如 ，第 二 回 合 会 消 耗 10%%的 超 能 力 值 。
		 目 前 的 超 能 力 值 消 耗 ：每 回 合 %0.1f 超 能 力 值 ]]):
