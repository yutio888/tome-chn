...
registerTalentTranslation{
	...
	info = function(self, t)
		...
		return ([[一圈闪电从你身上放射出来，在 %d 码范围内对目标造成 %0.2f ～ %0.2f 闪电伤害并有 75%% 概率眩晕敌人。 
		 受法术强度影响，伤害有额外加成。]]):format(radius, dam / 3, dam)
	end,
}
...
registerTalentTranslation{
	...
	info = function(self, t)
		...
		return ([[召唤一个闪电球对目标造成 %0.2f ～ %0.2f 闪电伤害并眩晕目标 3 回合。 
...
registerTalentTranslation{
	...
	info = function(self, t)
		...
		return ([[每次你的闪电法术眩晕目标时，它会有 %d%% 的概率发生连锁反应，生成一个围绕目标 %d 码半径范围的飓风，持续 10 回合。 
		 每回合该单位附近的所有生物会承受 %0.2f ～ %0.2f 闪电伤害。 
		 受法术强度影响，伤害有额外加成。]]):format(chance, radius, damage / 3, damage)
	end,
}
