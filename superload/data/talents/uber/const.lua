...
registerTalentTranslation{
	...
	name = "永不止步",
	require_special_desc = "掌握至少20级使用体力的技能",
	info = function(self, t)
...
registerTalentTranslation{
	...
	name = "影之护甲",
	require_special_desc = "曾造成超过50000点暗影伤害",
	info = function(self, t)
...
registerTalentTranslation{
	...
	name = "堕落之壳",
	require_special_desc = "承 受 过 至 少 7500 点 枯 萎 伤 害 并 和 大 堕 落 者 一 起 摧 毁 伊 格。",
	info = function(self, t)
