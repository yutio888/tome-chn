...
registerTalentTranslation{
	id = "T_ENDLESS_WOES",
	name = "无尽灾厄",
	require_special_desc = "曾 造 成 超 过 50000 点 酸 性、 枯 萎、 暗 影、 精 神 或 时 空 伤 害",
	info = function(self, t)
...
registerTalentTranslation{
	...
	name = "泰勒斯之秘",
	require_special_desc = "找到泰勒斯法杖的上半部，下半部和宝石。",
	info = function(self, t)
...
registerTalentTranslation{
	...
	name = "元素狂潮",
	require_special_desc = "曾 造 成 50000 点 奥 术、 火 焰、 冰 冷、 闪 电、 光 系 或 自 然 伤 害",
	info = function(self, t)
...
registerTalentTranslation{
	...
	name = "欺诈圣手",
	require_special_desc = "与盗贼领主同流合污",
	info = function(self, t)
