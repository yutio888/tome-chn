...
registerTalentTranslation{
	...
	name = "穿梭人群",
	require_special_desc = "同时拥有至少6名同伴",
...
registerTalentTranslation{
	id = "T_WINDBLADE",
	name = "剑刃风暴",
	require_special_desc = "曾使用双持武器造成超过50000点伤害",
	info = function(self, t)
...
registerTalentTranslation{
	...
	name = "和风守护",
	require_special_desc = "掌握至少20级使用失衡值的技能",
	info = function(self, t)
...
registerTalentTranslation{
	id = "T_GIANT_LEAP",
	name = "战争践踏",
	require_special_desc = "曾使用武器或徒手造成超过50000点伤害",
	info = function(self, t)
...
registerTalentTranslation{
	id = "T_CRAFTY_HANDS",
	name = "心灵手巧",
	require_special_desc = "学会5级的附魔技能",
	info = function(self, t)
...
registerTalentTranslation{
	id = "T_ROLL_WITH_IT",
	name = "随波逐流",
	require_special_desc = "曾被击退50次以上",
	info = function(self, t)
...
registerTalentTranslation{
	id = "T_VITAL_SHOT",
	name = "要害射击",
	require_special_desc = "曾使用远程武器造成50000点伤害",
	info = function(self, t)
