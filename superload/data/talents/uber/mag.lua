...
registerTalentTranslation{
	...
	info = function(self, t)
		return ([[你 获 得 25%% 绝 对 伤 害 抗 性， 25%% 全 体 伤 害 抗 性 穿 透。
		每 当 你 被 武 器 攻 击 的 时 候 ， 这 项 增 益 会 减 少 5%% ，8 回 合 后 完 全 恢 复。
		此 外 ， 你 将 获 得 相 当 于 你 魔 法 值 和 敏 捷 值 中 最 高 的 一 项   70%% 的 闪 避 值 (%d) ]])
...
registerTalentTranslation{
	...
	info = function(self, t)
		...
		你 在 灵 巧 / 毒 药 系 和 灵 巧 / 陷 阱 系 技 能 树 上 获 得 1 . 0 系 数 。
		你 的 毒 素 爆 发 技 能 冷 却 时 间 减 少 3。
		你 的 诱 饵 技 能 冷 却 时 间 减 少 5。
