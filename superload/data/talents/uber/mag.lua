...
registerTalentTranslation{
	...
	name = "无光之盾",
	require_special_desc = "掌 握 格 挡 技 能， 曾 释 放 过 100 个 法 术， 且 格 挡 强 度 超 过 200",
...
registerTalentTranslation{
	...
	name = "以太渗透",
	require_special_desc = "拥 有 至 少 25% 以 上 的 奥 术 抗 性， 并 且 曾 去 过 无 尽 虚 空",
	info = function(self, t)
...
registerTalentTranslation{
	...
	name = "魔之秘术",
	require_special_desc = "掌握陷阱或者毒药技能",
	info = function(self, t)
...
registerTalentTranslation{
	...
	info = function(self, t)
		...
		你 的 有 效 物 理 强 度 增 加 等 同 于 50%% 有 效 法 强 的 数 值。
...
registerTalentTranslation{
	id = "T_TEMPORAL_FORM",
	name = "时空形态",
	require_special_desc = "曾 释 放 过 1000 个 以 上 的 技 能 并 且 成 功 进 入 过 相 位 现 实。",
	info = function(self, t)
...
registerTalentTranslation{
	...
	name = "枯萎召唤",
	require_special_desc = "曾 召 唤 了 100 个 以 上 此 技 能 相 关 的 召 唤 生 物（ 炼 金 傀 儡 视 作 100 单 位）",
	info = function(self, t)
...
registerTalentTranslation{
	...
	name = "修正历史",
	require_special_desc = "曾经至少进行过一次时空穿越",
	info = function(self, t)
...
registerTalentTranslation{
	id = "T_CAUTERIZE",
	name = "浴火重生",
	require_special_desc = "曾 承 受 过 至 少 7500 点 火 焰 伤 害， 并 且 至 少 曾 释 放 过 1000 次 法 术。",
	info = function(self, t)
