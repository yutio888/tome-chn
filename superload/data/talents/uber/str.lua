...
registerTalentTranslation{
	id = "T_TITAN_S_SMASH",
	name = "化作星星吧！！",
	require_special_desc = "体型至少为巨大（使用也要满足此条件）",
	info = function(self, t)
...
registerTalentTranslation{
	id = "T_MASSIVE_BLOW",
	name = "巨人之锤",
	require_special_desc = "曾 挖 掉 至 少 30 块 石 头 / 树 木 / 等 等， 并 且 使 用 双 手 武 器 造 成 超 过 50000 点 伤 害",
	info = function(self, t)
...
registerTalentTranslation{
	...
	name = "无御之日",
	require_special_desc = "曾造成50000点以上的光系或者火系伤害",
	info = function(self, t)
...
registerTalentTranslation{
	...
	name = "纳鲁之传承",
	require_special_desc = "站在萨拉苏尔一方并且杀死厄库尔维斯克",
	info = function(self, t)
