...
registerTalentTranslation{
	id = "T_METEORIC_CRASH",
	name = "落星",
	require_special_desc = "曾亲眼目睹过陨石坠落",
	info = function(self, t)
...
registerTalentTranslation{
	...
	name = "加库尔的复仇",
	require_special_desc = "装备加库尔的两件宝物并且了解加库尔的一生",
	info = function(self, t)
...
registerTalentTranslation{
	...
	name = "潜能爆发",
	require_special_desc = "曾 获 得 千 钧 一 发 成 就（ 在 低 于 1HP 情 况 下 杀 死 1 个 敌 人）",
	info = function(self, t)
...
registerTalentTranslation{
	id = "T_LUCKY_DAY",
	name = "幸运日",
	require_special_desc = "拥有大运气。（至少有+5luck属性）",
	info = function(self, t)
...
registerTalentTranslation{
	id = "T_MENTAL_TYRANNY",
	name = "灵魂之怒",
	require_special_desc = "曾造成50000点精神伤害",
	info = function(self, t)
